...
def downgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS public.b23_webhook_ingestion_logs")  # CI:DESTRUCTIVE_OK - reversible downgrade for B2.3-P1 schema authority lock migration
    ...
    op.execute("DROP TABLE IF EXISTS public.b23_revenue_events")  # CI:DESTRUCTIVE_OK - reversible downgrade for B2.3-P1 schema authority lock migration
    ...
    op.execute("DROP TABLE IF EXISTS public.b23_exception_records")  # CI:DESTRUCTIVE_OK - reversible downgrade for B2.3-P1 schema authority lock migration
    ...
    op.execute("DROP TABLE IF EXISTS public.b23_match_verdicts")  # CI:DESTRUCTIVE_OK - reversible downgrade for B2.3-P1 schema authority lock migration
