...
Revision ID: 202511131120
Revises: 202511131119
Create Date: 2025-11-13 11:20:00

Migration Description:
Enables Row-Level Security (RLS) and creates tenant isolation policies for all tenant-scoped tables:
- attribution_events
- dead_events
...
revision: str = '202511131120'
down_revision: Union[str, None] = '202511131119'
...
def upgrade() -> None:
    """
    Enable RLS and create tenant isolation policies for all tenant-scoped tables.
