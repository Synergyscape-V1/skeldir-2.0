...
.PHONY: help dev migrate api worker health smoke test test-unit-pure test-db-invariant test-db-direct test-db-pooler test-fail-visible-tenant-context test-celery-eager test-celery-worker test-celery-worker-concurrent test-pooler-worker-concurrent test-broker-topology test-parallel-isolation test-b23-representative test-b24-persistence-readiness test-b24-persistence-entry-gate test-governance test-e2e test-external-db-smoke validate-ci-governance validate-ops-runbooks validate-m5-b24-readiness validate-m6-llm-boundary validate-m7-b24-readiness validate-b24-p1-authority-schema validate-b24-p2-source-snapshot validate-b24-p3-fit-planning validate-b24-p4-resource-bounds validate-b24-p5-runtime-harness validate-b24-p6-real-fit-worker validate-b24-p7-diagnostics validate-b24-p8-artifact-lifecycle validate-b24-p9-worker-tenant-hygiene validate-b24-p10-projection validate-b24-p11-ci-gates validate-b24-p11-workflow-vacuity validate-b24-p11-live-branch-protection validate-b24-p11-execution-artifacts validate-b24-p12-internal-e2e validate-b25-p1-contracts validate-b25-p1-trust-drift validate-b25-p2-canonicalization validate-b25-p2-canonicalization-negative validate-b25-p3-text-disposition validate-b25-p3-text-disposition-negative validate-b25-p4-money-authority validate-b25-p4-money-authority-negative validate-b25-p5-builder validate-b25-p5-builder-negative validate-b25-p6-reason-truth-matrix validate-b25-p6-reason-truth-matrix-negative validate-b25-p7-provenance-audit validate-b25-p7-provenance-audit-negative validate-b25-p8-signing-verification validate-b25-p8-signing-verification-negative validate-b25-p9-machine-identity validate-b25-p9-machine-identity-negative validate-b25-p10-trust-api-surface validate-b25-p10-trust-api-surface-negative validate-b25-p11-export-compatibility validate-b25-p13-c13-closure ops-dlq-inspect ops-queues ops-worker-inspect ops-rls-check ops-b23-trace ops-webhook-replay-local ops-seed-diagnostics ops-clear-diagnostics ops-runtime-proof ci-topology ci-enforcer-registry-check ci-gate-subsumption-check ci-b24-gate-dry-run ci-metrics ci-cohort-summary down logs contracts-check contracts-validate contracts-check-auth contracts-check-attribution models-generate mocks-start mocks-stop mocks-restart tests-integration backend-test frontend-test
...
validate-b24-p1-authority-schema: ## Run B2.4-P1 authority schema/module validator with negative control
	@python scripts/ci/validate_b24_p1_authority_schema.py --negative-control

validate-b24-p2-source-snapshot: ## Run B2.4-P2 source snapshot validator with negative control
	@python scripts/ci/validate_b24_p2_source_snapshot.py --negative-control

validate-b24-p3-fit-planning: ## Run B2.4-P3 fit planning/claim/outbox validator with negative control
...
validate-b24-p6-real-fit-worker: ## Run B2.4-P6 source-authorized real-fit worker validator with negative control
	@python scripts/ci/validate_b24_p6_real_fit_worker.py --negative-control

validate-b24-p7-diagnostics: ## Run B2.4-P7 diagnostic semantics validator with negative control
	@python scripts/ci/validate_b24_p7_diagnostics.py --negative-control

validate-b24-p8-artifact-lifecycle: ## Run B2.4-P8 artifact lifecycle validator with negative control
	@python scripts/ci/validate_b24_p8_artifact_lifecycle.py --negative-control

validate-b24-p9-worker-tenant-hygiene: ## Run B2.4-P9 worker tenant hygiene validator with negative control
	@python scripts/ci/validate_b24_p9_worker_tenant_hygiene.py --negative-control

validate-b24-p10-projection: ## Run B2.4-P10 read-only projection validator with negative control
	@python scripts/ci/validate_b24_p10_projection.py --negative-control

validate-b24-p11-ci-gates: ## Run B2.4-P11 CI gate matrix validator with negative controls
	@python scripts/ci/validate_b24_p11_ci_gates.py --negative-control

validate-b24-p11-workflow-vacuity: ## Run B2.4-P11 workflow path-filter/dummy-job validator with negative controls
	@python scripts/ci/validate_b24_p11_workflow_vacuity.py --negative-control

validate-b24-p11-live-branch-protection: ## Run B2.4-P11 live GitHub branch-protection validator with negative controls
	@python scripts/ci/validate_live_branch_protection.py --negative-control

validate-b24-p11-execution-artifacts: ## Run B2.4-P11 execution artifact validator with negative controls
	@python scripts/ci/validate_b24_p11_execution_artifacts.py --negative-control --negative-control-only

validate-b24-p12-internal-e2e: ## Run B2.4-P12 internal E2E harness validator with negative controls
	@python scripts/ci/validate_b24_p12_internal_e2e.py --negative-control
...
validate-b25-p2-canonicalization: ## Run B2.5-P2 canonicalization/hash identity validator with negative controls
	@python scripts/ci/validate_b25_p2_canonicalization.py --negative-control

validate-b25-p2-canonicalization-negative: ## Run B2.5-P2 canonicalization/hash identity negative-control validator
	@python scripts/ci/validate_b25_p2_canonicalization.py --negative-control

validate-b25-p3-text-disposition: ## Run B2.5-P3 deterministic untrusted text disposition validator with negative controls
	@python scripts/ci/validate_b25_p3_text_disposition.py --negative-control

validate-b25-p3-text-disposition-negative: ## Run B2.5-P3 text disposition negative-control validator
	@python scripts/ci/validate_b25_p3_text_disposition.py --negative-control

validate-b25-p4-money-authority: ## Run B2.5-P4 authoritative money source adapter validator with negative controls
...
validate-b25-p6-reason-truth-matrix: ## Run B2.5-P6 reason truth matrix validator with negative controls
	@python scripts/ci/validate_b25_p6_reason_truth_matrix.py --negative-control

validate-b25-p6-reason-truth-matrix-negative: ## Run B2.5-P6 reason truth matrix negative-control validator
	@python scripts/ci/validate_b25_p6_reason_truth_matrix.py --negative-control
...
validate-b25-p8-signing-verification: ## Run B2.5-P8 signing/verification validator with negative controls
	@python scripts/ci/validate_b25_p8_signing_verification.py --negative-control

validate-b25-p8-signing-verification-negative: ## Run B2.5-P8 signing/verification validator without nested pytest
	@python scripts/ci/validate_b25_p8_signing_verification.py --negative-control --skip-pytest
validate-b25-p9-machine-identity: ## Run B2.5-P9 machine identity/scopes/replay/rate-limit validator with negative controls
	@python scripts/ci/validate_b25_p9_machine_identity.py --negative-control
...
validate-b25-p11-export-compatibility: ## Run B2.5-P11 export compatibility validator with negative controls
	@python scripts/ci/validate_b25_p11_export_compatibility.py --negative-control

validate-b25-p13-c13-closure: ## Run Directive XIII semantic/topology validator
	@python scripts/ci/validate_b25_p13_c13_closure.py --negative-control
