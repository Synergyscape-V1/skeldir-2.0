...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26775040036
- **Generated at:** `2026-06-01T18:53:51.748531+00:00`
...
- `tenant_a` = `24eb635c-3679-5a78-9c66-3ae5e6d2cc6b`
- `tenant_b` = `b01b1282-c87c-578b-80a8-69b329ab5664`
...
{
  "N": 10,
  "candidate_sha": "85d7789b2bfff6847721ae2ea428733f83969747",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26775040036",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "d0df9332-b70d-5c80-98b3-e2f0358a9cee",
    ...
    "worker_pid_after": 3386,
    "worker_pid_before": 2932,
    "worker_pid_restarts": [
      2982,
      3026,
      3071,
...
```json
{
  ...
  "candidate_sha": "85d7789b2bfff6847721ae2ea428733f83969747",
  "db_truth": {
    "target_row_id": "be7c3aed-02e2-4d60-94ce-da0f1213f4f1"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26775040036",
