...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22777493888
- **Generated at:** `2026-03-06T18:56:13.695526+00:00`
...
- `tenant_a` = `0123ed04-b29a-5e21-99d9-daefe01dd012`
- `tenant_b` = `8c5b54f9-9b19-5045-ad39-65e3f5514ace`
...
{
  "N": 10,
  "candidate_sha": "67973f0f1aac4f6de711d4682715601d26bda1c4",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22777493888",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "77f2e81d-c65e-54ff-ba1f-f0a123c20511",
    ...
    "worker_pid_after": 3439,
    "worker_pid_before": 3014,
    "worker_pid_restarts": [
      3063,
      3107,
      3148,
...
```json
{
  ...
  "candidate_sha": "67973f0f1aac4f6de711d4682715601d26bda1c4",
  "db_truth": {
    "target_row_id": "fbc030f4-821a-437d-a124-e56a77af974b"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22777493888",
