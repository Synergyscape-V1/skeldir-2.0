...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26786394791
- **Generated at:** `2026-06-01T22:42:47.560092+00:00`
...
- `tenant_a` = `53bb8cef-22f9-5ed4-a80d-8d1fd5828473`
- `tenant_b` = `8e844432-af66-5ea8-b172-820144a0434c`
...
{
  "N": 10,
  "candidate_sha": "ef9e9ea1c34f55b8861ba1f6a7b681d3fb6539a5",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26786394791",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "9efe18da-2267-56ee-947f-dc9807449302",
    ...
    "worker_pid_after": 3455,
    "worker_pid_before": 2980,
    "worker_pid_restarts": [
      3030,
      3095,
      3142,
...
```json
{
  ...
  "candidate_sha": "ef9e9ea1c34f55b8861ba1f6a7b681d3fb6539a5",
  "db_truth": {
    "target_row_id": "e30862dd-006f-48b0-9e89-038a0b3289d7"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26786394791",
