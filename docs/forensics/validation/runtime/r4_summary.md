...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28142655675
- **Generated at:** `2026-06-25T02:25:49.233793+00:00`
...
- `tenant_a` = `0056551b-6575-5d23-b344-2c3596a7f2d6`
- `tenant_b` = `1a27fe6b-0b65-5655-a840-81726722b103`
...
{
  "N": 10,
  "candidate_sha": "2547f2a6b03d4d218c9ab3dfe50c4fe20f568ec0",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28142655675",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "5f8702b3-fd06-5392-82a9-2e01a73a790e",
    ...
    "worker_pid_after": 3412,
    "worker_pid_before": 2919,
    "worker_pid_restarts": [
      2979,
      3030,
      3074,
...
```json
{
  ...
  "candidate_sha": "2547f2a6b03d4d218c9ab3dfe50c4fe20f568ec0",
  "db_truth": {
    "target_row_id": "a6a3c188-d935-47b5-a314-e0d6c9adc9ee"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28142655675",
