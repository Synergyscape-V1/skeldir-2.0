...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27366710198
- **Generated at:** `2026-06-11T17:56:17.762940+00:00`
...
- `tenant_a` = `632509be-d9cf-5493-a84e-ee67d5a8bf20`
- `tenant_b` = `678274f6-f987-5248-87f8-5fbab0aa3df1`
...
{
  "N": 10,
  "candidate_sha": "d26aba78add4e29d667f53357e3a800466641963",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27366710198",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "1b1ce054-bf92-548c-8a72-493e3843708d",
    ...
    "worker_pid_after": 3472,
    "worker_pid_before": 2998,
    "worker_pid_restarts": [
      3051,
      3096,
      3139,
...
```json
{
  ...
  "candidate_sha": "d26aba78add4e29d667f53357e3a800466641963",
  "db_truth": {
    "target_row_id": "0a92a7e0-232a-4a40-af52-1852f7bfc70a"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27366710198",
