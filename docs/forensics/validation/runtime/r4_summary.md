...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33334033962
- **Generated at:** `2026-08-30T20:37:13.957586+00:00`
...
- `tenant_a` = `f68111ce-d934-5c40-b795-9079faceaf71`
- `tenant_b` = `d9e5638e-0f9f-530a-aa01-2b5dba4304ec`
...
{
  "N": 10,
  "candidate_sha": "c58d7ded044453a8a87aa6a72998bf1ea7584313",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33334033962",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "5689211e-b162-554a-9dd9-8fa668c0901d",
    ...
    "worker_pid_after": 3099,
    "worker_pid_before": 2625,
    "worker_pid_restarts": [
      2675,
      2721,
      2766,
...
```json
{
  ...
  "candidate_sha": "c58d7ded044453a8a87aa6a72998bf1ea7584313",
  "db_truth": {
    "target_row_id": "cb54d75a-bbbd-4c30-91b9-5f6880945ef3"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33334033962",
