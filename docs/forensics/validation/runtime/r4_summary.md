...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31341657561
- **Generated at:** `2026-08-09T23:24:52.989367+00:00`
...
- `tenant_a` = `d4e36cf7-bd8c-547d-9319-1eb60a2d3e26`
- `tenant_b` = `9c13b3dc-9c97-560d-8f47-e17a19178000`
...
{
  "N": 10,
  "candidate_sha": "601e05f0f814c0b59ffe085ee3f05f6669eee1b5",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31341657561",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "19b7cb4d-f5ef-5cb3-ae3a-61a2a49ee5c9",
    ...
    "worker_pid_after": 3416,
    "worker_pid_before": 2942,
    "worker_pid_restarts": [
      2993,
      3037,
      3081,
...
```json
{
  ...
  "candidate_sha": "601e05f0f814c0b59ffe085ee3f05f6669eee1b5",
  "db_truth": {
    "target_row_id": "8e8bb015-7967-45ab-8e94-d8e63b77cee6"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31341657561",
