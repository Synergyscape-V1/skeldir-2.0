...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24394675353
- **Generated at:** `2026-04-14T10:46:50.829510+00:00`
...
- `tenant_a` = `169d420c-6680-55cd-8683-287856e25536`
- `tenant_b` = `ffdb6a96-6578-52e5-bead-f47188dc3460`
...
{
  "N": 10,
  "candidate_sha": "d958d477a74d3150ead84aca171c11ffc61a06b0",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24394675353",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "0ca4f645-1a5e-59f3-98e9-50343c6dba2d",
    ...
    "worker_pid_after": 3368,
    "worker_pid_before": 2914,
    "worker_pid_restarts": [
      2962,
      3009,
      3051,
...
```json
{
  ...
  "candidate_sha": "d958d477a74d3150ead84aca171c11ffc61a06b0",
  "db_truth": {
    "target_row_id": "8da16a51-a29a-4ccf-bb07-0406c43b191d"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24394675353",
