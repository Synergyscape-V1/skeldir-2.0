...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24929452678
- **Generated at:** `2026-04-25T11:07:32.948429+00:00`
...
- `tenant_a` = `c7bb5c61-dc56-5c3d-b8b7-85598bcbf9a0`
- `tenant_b` = `ccdd8ac1-5f61-53ab-8dae-09716524b82a`
...
{
  "N": 10,
  "candidate_sha": "2d89c97a4416772d6845ce9c68ea66bf603831a5",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24929452678",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "11a61bef-d14a-5f37-93fd-0b499e402479",
    ...
    "worker_pid_after": 3260,
    "worker_pid_before": 2819,
    "worker_pid_restarts": [
      2867,
      2911,
      2954,
...
```json
{
  ...
  "candidate_sha": "2d89c97a4416772d6845ce9c68ea66bf603831a5",
  "db_truth": {
    "target_row_id": "3e7e664a-94a3-44f7-a143-27d0dbc4b12d"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24929452678",
