...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22555642423
- **Generated at:** `2026-03-01T23:43:57.194918+00:00`
...
- `tenant_a` = `71e0b33a-e7fa-5805-beb7-3fb104e41e2a`
- `tenant_b` = `d2458e52-cf70-5bd6-b0d5-9342ab68ac65`
...
{
  "N": 10,
  "candidate_sha": "e10ac8bf1357de1cd198f62bbb95433271c5c129",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22555642423",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "295eb6c4-ca06-563d-81d5-e67422740666",
    ...
    "worker_pid_after": 3344,
    "worker_pid_before": 2903,
    "worker_pid_restarts": [
      2954,
      2997,
      3041,
...
```json
{
  ...
  "candidate_sha": "e10ac8bf1357de1cd198f62bbb95433271c5c129",
  "db_truth": {
    "target_row_id": "dc0eb471-c281-4a3a-8c3a-e5bb68b05b24"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22555642423",
