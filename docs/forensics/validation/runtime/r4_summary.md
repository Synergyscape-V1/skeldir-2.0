...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27428506940
- **Generated at:** `2026-06-12T16:25:15.670804+00:00`
...
- `tenant_a` = `fc831fb6-1dc9-5a45-848e-ad92dd3883ad`
- `tenant_b` = `52a26bc5-b589-5199-9f08-2e9356a9e087`
...
{
  "N": 10,
  "candidate_sha": "51b625d2105d2ffd1f35f62ece714cd8fe23faa0",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27428506940",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "7aceb839-2ed4-5a91-b204-1107f29baae0",
    ...
    "worker_pid_after": 3496,
    "worker_pid_before": 3015,
    "worker_pid_restarts": [
      3066,
      3139,
      3183,
...
```json
{
  ...
  "candidate_sha": "51b625d2105d2ffd1f35f62ece714cd8fe23faa0",
  "db_truth": {
    "target_row_id": "a00b0bab-ddab-4915-abbe-5bc1a7f0e8fb"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27428506940",
