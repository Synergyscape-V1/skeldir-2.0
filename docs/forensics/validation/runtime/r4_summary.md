...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24289755711
- **Generated at:** `2026-04-11T19:25:33.128247+00:00`
...
- `tenant_a` = `be02a337-d603-5418-b538-7f041493cb0b`
- `tenant_b` = `c0278933-15a6-5196-a5b3-0e47d3a96d61`
...
{
  "N": 10,
  "candidate_sha": "fe2f305fead9a1bcbf03a91a35257d88a33159cc",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24289755711",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "fc204bff-5fd5-5512-87b0-219e9aaa0e69",
    ...
    "worker_pid_after": 3336,
    "worker_pid_before": 2852,
    "worker_pid_restarts": [
      2903,
      2950,
      2995,
...
```json
{
  ...
  "candidate_sha": "fe2f305fead9a1bcbf03a91a35257d88a33159cc",
  "db_truth": {
    "target_row_id": "40ee206d-3860-4b4d-8a9e-c5aee13b00b4"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24289755711",
