...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31280838297
- **Generated at:** `2026-08-08T22:09:37.713817+00:00`
...
- `tenant_a` = `9e00c15e-70ac-5bbc-89ab-870ddde25b82`
- `tenant_b` = `56dc9bd9-5425-5393-972f-e3a1e83ea55d`
...
{
  "N": 10,
  "candidate_sha": "b7385e04e0c66add56ffd36eabf86ec92cdd3429",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31280838297",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "af8e8f83-2b24-5af4-aec7-f5d9edcb9018",
    ...
    "worker_pid_after": 3546,
    "worker_pid_before": 2991,
    "worker_pid_restarts": [
      3046,
      3092,
      3137,
...
```json
{
  ...
  "candidate_sha": "b7385e04e0c66add56ffd36eabf86ec92cdd3429",
  "db_truth": {
    "target_row_id": "84e9ca7a-6aba-4b69-b21f-803ff2111696"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31280838297",
