...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32379189988
- **Generated at:** `2026-08-20T14:20:46.919704+00:00`
...
- `tenant_a` = `839e46f0-c3d6-5062-b7d5-0f14a8b2e9b3`
- `tenant_b` = `e5418b65-8a3a-5f45-8cbe-c2b7a4d834c9`
...
{
  "N": 10,
  "candidate_sha": "bc470d52ad09922bc03f756f023dcbffae8db138",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32379189988",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "203f2376-d5a3-5464-9ba0-287a50a93ba2",
    ...
    "worker_pid_after": 3268,
    "worker_pid_before": 2789,
    "worker_pid_restarts": [
      2841,
      2887,
      2930,
...
```json
{
  ...
  "candidate_sha": "bc470d52ad09922bc03f756f023dcbffae8db138",
  "db_truth": {
    "target_row_id": "18cf8daf-35eb-45c2-a39d-6100683ee9f5"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32379189988",
