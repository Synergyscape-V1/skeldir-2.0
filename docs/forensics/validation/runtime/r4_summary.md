...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22509526954
- **Generated at:** `2026-02-28T00:46:46.844662+00:00`
...
- `tenant_a` = `5c77786d-4e82-567d-87d3-a9ea403b1967`
- `tenant_b` = `3920ff54-5848-5126-bdde-63d28dd37730`
...
{
  "N": 10,
  "candidate_sha": "d6a1da29828839afed8a2063efa31ee622cd58e2",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22509526954",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "aacb102b-e4b8-5c07-a6d4-af91c0243492",
    ...
    "worker_pid_after": 3228,
    "worker_pid_before": 2804,
    "worker_pid_restarts": [
      2849,
      2895,
      2937,
...
```json
{
  ...
  "candidate_sha": "d6a1da29828839afed8a2063efa31ee622cd58e2",
  "db_truth": {
    "target_row_id": "5ed44b2c-e6da-4632-9887-0008b1d7d798"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22509526954",
