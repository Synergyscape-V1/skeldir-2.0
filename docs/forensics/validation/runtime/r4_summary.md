...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35126956413
- **Generated at:** `2026-09-16T17:17:17.737502+00:00`
...
- `tenant_a` = `6887f316-34e3-5547-a222-aacf45d1abc4`
- `tenant_b` = `b27c9444-535f-5249-bac6-523d94cf26f2`
...
{
  "N": 10,
  "candidate_sha": "913c05b281a9c4a52870798ff89b90afdfc0bf2a",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35126956413",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "adc78194-4b1d-5bec-a434-52532458f03a",
    ...
    "worker_pid_after": 3342,
    "worker_pid_before": 2861,
    "worker_pid_restarts": [
      2911,
      2955,
      3001,
...
```json
{
  ...
  "candidate_sha": "913c05b281a9c4a52870798ff89b90afdfc0bf2a",
  "db_truth": {
    "target_row_id": "a4b60e52-a525-46c6-b1d3-e99364e27edf"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35126956413",
