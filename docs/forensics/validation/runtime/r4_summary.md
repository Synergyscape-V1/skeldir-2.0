...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23949456985
- **Generated at:** `2026-04-03T14:24:14.211296+00:00`
...
- `tenant_a` = `de325cf1-e1a2-526e-8566-1d8827ebe636`
- `tenant_b` = `501d67b0-de04-50fa-b6d5-d0d3e0c667eb`
...
{
  "N": 10,
  "candidate_sha": "a65083c08c0a632657ad94836e2f3ce459afb164",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23949456985",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "7e1cfc2e-c3fb-5ebd-854b-026580cee4d1",
    ...
    "worker_pid_after": 3304,
    "worker_pid_before": 2825,
    "worker_pid_restarts": [
      2875,
      2922,
      2966,
...
```json
{
  ...
  "candidate_sha": "a65083c08c0a632657ad94836e2f3ce459afb164",
  "db_truth": {
    "target_row_id": "f6a128e3-ae98-4bfa-a9af-e9750243151a"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23949456985",
