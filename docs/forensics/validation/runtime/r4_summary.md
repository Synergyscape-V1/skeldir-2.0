...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23148966233
- **Generated at:** `2026-03-16T14:34:08.928793+00:00`
...
- `tenant_a` = `7e232cd3-9287-5ecf-80f5-123527d44b7d`
- `tenant_b` = `a28eb053-622b-5955-83d3-5345f4caacd9`
...
{
  "N": 10,
  "candidate_sha": "c9dd402c7299a366183f0eeb69aa655cd66be017",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23148966233",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "3a3cb7d8-adbf-5ba4-a1ce-b59b53b5135d",
    ...
    "worker_pid_after": 3347,
    "worker_pid_before": 2891,
    "worker_pid_restarts": [
      2942,
      2986,
      3029,
...
```json
{
  ...
  "candidate_sha": "c9dd402c7299a366183f0eeb69aa655cd66be017",
  "db_truth": {
    "target_row_id": "67767c68-b5bb-4f0e-b6eb-76e1ab76a85e"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23148966233",
