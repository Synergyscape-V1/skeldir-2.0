...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23011794541
- **Generated at:** `2026-03-12T16:14:30.643729+00:00`
...
- `tenant_a` = `8ee549fb-23f1-572c-9c35-e0206a204b0d`
- `tenant_b` = `79cf3297-a022-55aa-a42e-dcb1f6b00f6b`
...
{
  "N": 10,
  "candidate_sha": "695afa30bf7b54acb728b4d9cf9269f9709a6bff",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23011794541",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "470482a9-9602-5bb8-b5a8-2dcab1aa8850",
    ...
    "worker_pid_after": 3505,
    "worker_pid_before": 3025,
    "worker_pid_restarts": [
      3076,
      3120,
      3167,
...
```json
{
  ...
  "candidate_sha": "695afa30bf7b54acb728b4d9cf9269f9709a6bff",
  "db_truth": {
    "target_row_id": "c2716615-801c-4d82-9495-36301e7064da"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23011794541",
