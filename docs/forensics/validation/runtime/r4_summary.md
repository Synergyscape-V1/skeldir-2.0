...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26254823963
- **Generated at:** `2026-05-21T21:45:18.102895+00:00`
...
- `tenant_a` = `a5cd6ec1-5ddb-5155-9a5d-e2332598421e`
- `tenant_b` = `66d9d046-cfb8-5192-af3f-98d3ddc54e51`
...
{
  "N": 10,
  "candidate_sha": "b2c21961fa75156a7522398fd7fdee32b9d6790e",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26254823963",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "6b47ae1c-3fd1-56e4-bd58-ee08024405db",
    ...
    "worker_pid_after": 3346,
    "worker_pid_before": 2868,
    "worker_pid_restarts": [
      2920,
      2986,
      3031,
...
```json
{
  ...
  "candidate_sha": "b2c21961fa75156a7522398fd7fdee32b9d6790e",
  "db_truth": {
    "target_row_id": "48fc7b52-e960-424e-99fe-ce659e87db55"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26254823963",
