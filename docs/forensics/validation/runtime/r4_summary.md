...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32425451567
- **Generated at:** `2026-08-20T22:47:09.092912+00:00`
...
- `tenant_a` = `3fb3c7c5-e157-508f-9ec6-af66a86a1acf`
- `tenant_b` = `a871dfcb-1976-5d3c-911d-fa467e63c92d`
...
{
  "N": 10,
  "candidate_sha": "eb0f1227a8e4f95cc52707b16d0251d03c850942",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32425451567",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "87da94f3-3326-5279-b02b-f36c1f9cfcfd",
    ...
    "worker_pid_after": 3269,
    "worker_pid_before": 2788,
    "worker_pid_restarts": [
      2838,
      2885,
      2951,
...
```json
{
  ...
  "candidate_sha": "eb0f1227a8e4f95cc52707b16d0251d03c850942",
  "db_truth": {
    "target_row_id": "03ae6b10-cf48-472e-b7b6-646437bdff3b"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32425451567",
