...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26534225760
- **Generated at:** `2026-05-27T19:39:34.872366+00:00`
...
- `tenant_a` = `d9317771-b362-5ddc-a074-b43eaca337d0`
- `tenant_b` = `fa18e313-7427-52a4-bab3-cd645d02ecd7`
...
{
  "N": 10,
  "candidate_sha": "3fbe1f8c862702e99e13cd2bad200b7875bfbf43",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26534225760",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "6bb21bad-9fba-5603-8fb6-20d47610b027",
    ...
    "worker_pid_after": 3475,
    "worker_pid_before": 2941,
    "worker_pid_restarts": [
      3012,
      3057,
      3101,
...
```json
{
  ...
  "candidate_sha": "3fbe1f8c862702e99e13cd2bad200b7875bfbf43",
  "db_truth": {
    "target_row_id": "2cdb2e6d-f2ab-43f0-a20f-5931a66b2d81"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26534225760",
