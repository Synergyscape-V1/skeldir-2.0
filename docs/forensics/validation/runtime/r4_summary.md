...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24692438474
- **Generated at:** `2026-04-20T21:59:32.408570+00:00`
...
- `tenant_a` = `e1d4843b-6a7d-50c4-995b-55e9cfe8aae1`
- `tenant_b` = `137fa306-81de-5aa5-9cad-32e8dbe7bf6a`
...
{
  "N": 10,
  "candidate_sha": "a2c9176a04905dbd129007bd88aa57e047c2be5f",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24692438474",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "48bc9181-b9d5-5a63-9fbd-537ea0533b6b",
    ...
    "worker_pid_after": 3365,
    "worker_pid_before": 2834,
    "worker_pid_restarts": [
      2884,
      2930,
      2975,
...
```json
{
  ...
  "candidate_sha": "a2c9176a04905dbd129007bd88aa57e047c2be5f",
  "db_truth": {
    "target_row_id": "c460fb53-dbb1-402a-b783-fabffe4bd4e2"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24692438474",
