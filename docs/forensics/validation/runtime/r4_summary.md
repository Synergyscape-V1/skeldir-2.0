...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26366952357
- **Generated at:** `2026-05-24T16:45:55.768146+00:00`
...
- `tenant_a` = `5bfff23e-d54a-5194-b0fc-51863c036e2e`
- `tenant_b` = `ef030476-1071-59fb-821f-e49c8b3ca0d7`
...
{
  "N": 10,
  "candidate_sha": "fe2b5aeb0287f742d18faf0b4aaa64d3de70b508",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26366952357",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "8d5a3062-0d41-502a-b80a-1c80b101e683",
    ...
    "worker_pid_after": 3564,
    "worker_pid_before": 3048,
    "worker_pid_restarts": [
      3100,
      3145,
      3190,
...
```json
{
  ...
  "candidate_sha": "fe2b5aeb0287f742d18faf0b4aaa64d3de70b508",
  "db_truth": {
    "target_row_id": "efb8ea80-8e63-462b-8bcc-68f359c8ab58"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26366952357",
