...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25443933019
- **Generated at:** `2026-05-06T15:15:19.918904+00:00`
...
- `tenant_a` = `b1f13613-4913-5ca3-b940-467e8381fd13`
- `tenant_b` = `67db91f6-2212-5a2d-814b-fd245b92d920`
...
{
  "N": 10,
  "candidate_sha": "40670f151b960e7bd26cae80a7af143a8a6d34dc",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25443933019",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "89b235bc-9ecc-5394-9c83-c718a17f7c93",
    ...
    "worker_pid_after": 3463,
    "worker_pid_before": 3008,
    "worker_pid_restarts": [
      3060,
      3104,
      3149,
...
```json
{
  ...
  "candidate_sha": "40670f151b960e7bd26cae80a7af143a8a6d34dc",
  "db_truth": {
    "target_row_id": "067364da-b2a5-4142-b8e5-b0373cc374b9"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25443933019",
