...
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/22022486507
- **Generated at:** `2026-02-14T18:51:34.722315+00:00`
...
- `tenant_a` = `3f8a7a63-79ca-5dbc-b373-e76671947fc9`
- `tenant_b` = `c1a76f20-9802-5875-a2f1-3d517b3fb2c0`
...
{
  "N": 10,
  "candidate_sha": "669ddd991e2a981a2a46cc5bce1a772efe770e8c",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/22022486507",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "169af0ac-7e21-5cd6-b985-1dbcce61eb34",
    ...
    "worker_pid_after": 3130,
    "worker_pid_before": 2710,
    "worker_pid_restarts": [
      2757,
      2801,
      2841,
...
```json
{
  ...
  "candidate_sha": "669ddd991e2a981a2a46cc5bce1a772efe770e8c",
  "db_truth": {
    "target_row_id": "5f7e6414-6bec-42ba-a234-ab53e7e69eb2"
  },
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/22022486507",
