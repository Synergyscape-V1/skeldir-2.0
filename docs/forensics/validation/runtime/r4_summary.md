...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28457033508
- **Generated at:** `2026-06-30T15:48:27.497560+00:00`
...
- `tenant_a` = `5bc7f3ae-330b-5343-b7db-1262c61817bb`
- `tenant_b` = `fd13b32d-e314-5773-bb4c-fcee28a89dc4`
...
{
  "N": 10,
  "candidate_sha": "c4023837448af7747783cd8ac03091b936f9206e",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28457033508",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "707257e7-0fd3-53a4-8ebe-b94fbae92434",
    ...
    "worker_pid_after": 3479,
    "worker_pid_before": 3003,
    "worker_pid_restarts": [
      3055,
      3124,
      3168,
...
```json
{
  ...
  "candidate_sha": "c4023837448af7747783cd8ac03091b936f9206e",
  "db_truth": {
    "target_row_id": "ff29cf00-99fe-43e5-a6a6-0988845dfa8f"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28457033508",
