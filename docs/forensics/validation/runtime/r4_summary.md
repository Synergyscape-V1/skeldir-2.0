...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32613607853
- **Generated at:** `2026-08-23T02:47:13.103575+00:00`
...
- `tenant_a` = `76ffc2c1-1633-5ea3-adb4-c00a18fafe60`
- `tenant_b` = `f115ac50-7ce0-5529-8ca2-99ac472645ba`
...
{
  "N": 10,
  "candidate_sha": "b99dca34185fa98e87f47e11f7fc5f20b721dc77",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32613607853",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "1abbbcd2-97e7-5672-9fec-56a2cbdcac08",
    ...
    "worker_pid_after": 3265,
    "worker_pid_before": 2779,
    "worker_pid_restarts": [
      2830,
      2876,
      2923,
...
```json
{
  ...
  "candidate_sha": "b99dca34185fa98e87f47e11f7fc5f20b721dc77",
  "db_truth": {
    "target_row_id": "fbbdfc84-c101-4024-b0d7-084f5392f786"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32613607853",
