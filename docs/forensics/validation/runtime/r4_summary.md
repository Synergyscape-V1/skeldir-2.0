...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22634785189
- **Generated at:** `2026-03-03T17:26:38.247924+00:00`
...
- `tenant_a` = `6158e8f5-d041-56cf-a950-333611bb14ab`
- `tenant_b` = `2387c0ea-6c9d-58a8-9c8a-2d00f105e739`
...
{
  "N": 10,
  "candidate_sha": "89b57ecd4e3837658d11614c8a6460cf9a540511",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22634785189",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "e5d66a4d-4ad8-5349-967a-ade7b93ca355",
    ...
    "worker_pid_after": 3263,
    "worker_pid_before": 2818,
    "worker_pid_restarts": [
      2864,
      2908,
      2949,
...
```json
{
  ...
  "candidate_sha": "89b57ecd4e3837658d11614c8a6460cf9a540511",
  "db_truth": {
    "target_row_id": "a9e6f940-9dc7-4402-b0f9-13e1c50248da"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22634785189",
