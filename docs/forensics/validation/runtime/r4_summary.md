...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23857221473
- **Generated at:** `2026-04-01T15:45:02.421764+00:00`
...
- `tenant_a` = `d41138d0-ea98-5c84-abb9-267ede828a6a`
- `tenant_b` = `3983a7bb-667c-5acc-a75d-f8ad1d12eb3e`
...
{
  "N": 10,
  "candidate_sha": "f5014b5fe7bed8fb74f22584db9be4af62f5af35",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23857221473",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "1e5b0b39-611b-5ebf-9093-4023cfb14c04",
    ...
    "worker_pid_after": 3456,
    "worker_pid_before": 2982,
    "worker_pid_restarts": [
      3035,
      3091,
      3141,
...
```json
{
  ...
  "candidate_sha": "f5014b5fe7bed8fb74f22584db9be4af62f5af35",
  "db_truth": {
    "target_row_id": "fb6008a5-b730-46cc-8da7-4dfd3fb71cbc"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23857221473",
