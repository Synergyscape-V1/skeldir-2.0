...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22590523212
- **Generated at:** `2026-03-02T18:46:27.977569+00:00`
...
- `tenant_a` = `9b6dc564-634a-54bb-9ca9-77e56980c24f`
- `tenant_b` = `a4f00c5a-ea88-5010-a616-95ad13aa9033`
...
{
  "N": 10,
  "candidate_sha": "be61ff45799bb43d4b719f0b9657535bae8afd32",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22590523212",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "cb4e67be-8064-513a-a704-493739e94d66",
    ...
    "worker_pid_after": 3355,
    "worker_pid_before": 2924,
    "worker_pid_restarts": [
      2970,
      3013,
      3059,
...
```json
{
  ...
  "candidate_sha": "be61ff45799bb43d4b719f0b9657535bae8afd32",
  "db_truth": {
    "target_row_id": "a12d2fcc-0bed-4727-8c20-7faf9a26a646"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22590523212",
