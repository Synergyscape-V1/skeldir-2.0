...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22548458328
- **Generated at:** `2026-03-01T17:21:34.289803+00:00`
...
- `tenant_a` = `f332f273-e616-57b0-b042-4ac45d6f9638`
- `tenant_b` = `35fca94f-2dab-5b70-94a4-6ba93fda0d90`
...
{
  "N": 10,
  "candidate_sha": "c13b1e74a90fd025c797f9c8c14050c56fb222d2",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22548458328",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "11f11ae3-3c13-5925-b224-ebd40161b1b3",
    ...
    "worker_pid_after": 3266,
    "worker_pid_before": 2833,
    "worker_pid_restarts": [
      2881,
      2923,
      2966,
...
```json
{
  ...
  "candidate_sha": "c13b1e74a90fd025c797f9c8c14050c56fb222d2",
  "db_truth": {
    "target_row_id": "110d59dd-b7f2-4a34-8570-dd71dd0e54ff"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22548458328",
