...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33448645997
- **Generated at:** `2026-08-31T23:01:51.560454+00:00`
...
- `tenant_a` = `8bba3418-deaf-526a-926f-9d9493bc7715`
- `tenant_b` = `37331b1b-0683-5ab5-b9d0-abc51a9f445e`
...
{
  "N": 10,
  "candidate_sha": "7752a79d1f7052ec7f159a989127f2e262f55e91",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33448645997",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "b52d31d8-2172-5e48-a66f-58576c7cebc3",
    ...
    "worker_pid_after": 3152,
    "worker_pid_before": 2653,
    "worker_pid_restarts": [
      2706,
      2753,
      2819,
...
```json
{
  ...
  "candidate_sha": "7752a79d1f7052ec7f159a989127f2e262f55e91",
  "db_truth": {
    "target_row_id": "bb0807c3-eac8-4f6b-8d40-0e9303e875f4"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33448645997",
