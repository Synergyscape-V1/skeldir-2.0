...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25218107924
- **Generated at:** `2026-05-01T14:31:22.247376+00:00`
...
- `tenant_a` = `04df4e26-e85b-5961-9a99-69523d66a518`
- `tenant_b` = `12b63508-803c-5094-8fde-fd966c73255a`
...
{
  "N": 10,
  "candidate_sha": "fbb4f634625567f3926db9d16959301fa1edbcf2",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25218107924",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "5dca8177-4d71-5435-a94c-61224336820c",
    ...
    "worker_pid_after": 4018,
    "worker_pid_before": 3535,
    "worker_pid_restarts": [
      3587,
      3632,
      3676,
...
```json
{
  ...
  "candidate_sha": "fbb4f634625567f3926db9d16959301fa1edbcf2",
  "db_truth": {
    "target_row_id": "36636ea8-9a56-4fc6-9966-f1f6ff685146"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25218107924",
