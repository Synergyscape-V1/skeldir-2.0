...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25562672130
- **Generated at:** `2026-05-08T15:01:27.904310+00:00`
...
- `tenant_a` = `c180eb3d-6955-5c45-91a4-b11d632ff22c`
- `tenant_b` = `823122f2-1abb-528d-a7b1-c1de854ff408`
...
{
  "N": 10,
  "candidate_sha": "cd9b4a307431460fe33d28b4d491a484ae549982",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25562672130",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "f0117091-6443-5ce9-bc5d-384ec2e01e97",
    ...
    "worker_pid_after": 3480,
    "worker_pid_before": 3002,
    "worker_pid_restarts": [
      3052,
      3100,
      3165,
...
```json
{
  ...
  "candidate_sha": "cd9b4a307431460fe33d28b4d491a484ae549982",
  "db_truth": {
    "target_row_id": "4c6f59fd-c09a-41a3-bb6d-6d5e9f32fbc6"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25562672130",
