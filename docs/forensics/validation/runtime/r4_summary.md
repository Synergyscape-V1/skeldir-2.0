...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24315033366
- **Generated at:** `2026-04-12T19:55:21.659183+00:00`
...
- `tenant_a` = `6233ed11-d2bb-5f34-a7d1-a37ec92c7581`
- `tenant_b` = `b13bb1ed-76fd-5dc6-a874-1a7b2f990133`
...
{
  "N": 10,
  "candidate_sha": "d0a7a7aec7d847ff8556e50a46eac7dc4060c5f2",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24315033366",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "f3cd1791-e507-5d2a-9ecd-eedbd3f586ee",
    ...
    "worker_pid_after": 3462,
    "worker_pid_before": 3013,
    "worker_pid_restarts": [
      3063,
      3107,
      3151,
...
```json
{
  ...
  "candidate_sha": "d0a7a7aec7d847ff8556e50a46eac7dc4060c5f2",
  "db_truth": {
    "target_row_id": "16c899f6-946d-4cb8-839b-6b668a04436d"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24315033366",
