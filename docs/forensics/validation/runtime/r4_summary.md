...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24630111257
- **Generated at:** `2026-04-19T13:25:35.514870+00:00`
...
- `tenant_a` = `b735f893-6dda-56b6-b092-af80de113bac`
- `tenant_b` = `f950fb8a-def3-553d-9906-5e6cc3daf3a9`
...
{
  "N": 10,
  "candidate_sha": "d3044897ccd4ef39caccdc0d5ece15bc716778da",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24630111257",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "b38cc659-97e2-5a5e-bf1f-21683fba212e",
    ...
    "worker_pid_after": 3481,
    "worker_pid_before": 3017,
    "worker_pid_restarts": [
      3067,
      3114,
      3157,
...
```json
{
  ...
  "candidate_sha": "d3044897ccd4ef39caccdc0d5ece15bc716778da",
  "db_truth": {
    "target_row_id": "f9a817f8-f789-4920-a4b0-883c0e3fe5cc"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24630111257",
