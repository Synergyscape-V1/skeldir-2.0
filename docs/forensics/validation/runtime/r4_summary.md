...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34046802397
- **Generated at:** `2026-09-06T16:55:13.116992+00:00`
...
- `tenant_a` = `33695395-b443-5eca-b971-4d60e4312807`
- `tenant_b` = `7ee453b7-a62e-5434-9a9e-0ca5895194bc`
...
{
  "N": 10,
  "candidate_sha": "d4ccb8165e8e3326ca671251907577422cf96214",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34046802397",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "755beb8b-d52b-59bf-a8d5-5bb5efbb7016",
    ...
    "worker_pid_after": 3514,
    "worker_pid_before": 3023,
    "worker_pid_restarts": [
      3074,
      3118,
      3164,
...
```json
{
  ...
  "candidate_sha": "d4ccb8165e8e3326ca671251907577422cf96214",
  "db_truth": {
    "target_row_id": "a729be01-6b0e-4344-b881-2d451e1ef5dc"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34046802397",
