...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27072077940
- **Generated at:** `2026-06-06T19:47:27.588224+00:00`
...
- `tenant_a` = `a81b727e-d911-51f1-96ac-47eba04a54d3`
- `tenant_b` = `442e738d-11d1-5df8-9558-b9b98a338369`
...
{
  "N": 10,
  "candidate_sha": "465eca225ba906ef4e8818ca32b910952d47f3b6",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27072077940",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "d126dbd5-eacb-5c83-9ede-a4acb61915dc",
    ...
    "worker_pid_after": 3325,
    "worker_pid_before": 2848,
    "worker_pid_restarts": [
      2920,
      2965,
      3009,
...
```json
{
  ...
  "candidate_sha": "465eca225ba906ef4e8818ca32b910952d47f3b6",
  "db_truth": {
    "target_row_id": "ffbf91e2-d178-4b6e-8dda-020729429186"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27072077940",
