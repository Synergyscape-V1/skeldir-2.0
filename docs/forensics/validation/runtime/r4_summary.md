...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22907482338
- **Generated at:** `2026-03-10T14:30:44.050049+00:00`
...
- `tenant_a` = `705eba88-b754-5a62-a38a-9dee180cfa64`
- `tenant_b` = `c6b48e67-9304-5c54-abe1-4a927659e86c`
...
{
  "N": 10,
  "candidate_sha": "4682bd4a9bf9f88a21804b6d5f1dae7b58184bd5",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22907482338",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "af08a01c-1834-59ee-9db6-5857b150ac6d",
    ...
    "worker_pid_after": 3419,
    "worker_pid_before": 2872,
    "worker_pid_restarts": [
      2992,
      3037,
      3102,
...
```json
{
  ...
  "candidate_sha": "4682bd4a9bf9f88a21804b6d5f1dae7b58184bd5",
  "db_truth": {
    "target_row_id": "26764b49-aa5f-4f6f-992a-30ed96cb25c5"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22907482338",
