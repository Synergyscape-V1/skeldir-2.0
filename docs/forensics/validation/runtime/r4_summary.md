...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25801300948
- **Generated at:** `2026-05-13T13:15:27.569943+00:00`
...
- `tenant_a` = `709a679f-6c22-54b0-85ce-aa2baefcf4a3`
- `tenant_b` = `8095e838-971a-5049-8765-0efc31aa084f`
...
{
  "N": 10,
  "candidate_sha": "9656025f911517c6b4702e6e474ea92f282fe64d",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25801300948",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "88d8d961-ba45-5c9d-847b-eef407427318",
    ...
    "worker_pid_after": 3464,
    "worker_pid_before": 2984,
    "worker_pid_restarts": [
      3033,
      3081,
      3125,
...
```json
{
  ...
  "candidate_sha": "9656025f911517c6b4702e6e474ea92f282fe64d",
  "db_truth": {
    "target_row_id": "b77a1b7d-c7c8-4d60-918d-a6e7cb487c72"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25801300948",
