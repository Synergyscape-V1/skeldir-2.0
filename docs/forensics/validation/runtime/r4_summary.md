...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22076329719
- **Generated at:** `2026-02-16T20:17:39.561445+00:00`
...
- `tenant_a` = `2a5cfed6-c2f6-5060-865e-c271836d6dfd`
- `tenant_b` = `dd639bba-a083-5625-b9f8-c8ecc9c7dd4b`
...
{
  "N": 10,
  "candidate_sha": "045eca369a2de683adc92c2afb240d44c06038db",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22076329719",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "b1d55fdf-5ae8-5753-9dd9-29542a25cd1e",
    ...
    "worker_pid_after": 3166,
    "worker_pid_before": 2737,
    "worker_pid_restarts": [
      2787,
      2828,
      2869,
...
```json
{
  ...
  "candidate_sha": "045eca369a2de683adc92c2afb240d44c06038db",
  "db_truth": {
    "target_row_id": "3c056605-824e-46ff-b3c3-8a0f7da9886c"
  },
  "passed": true,
  "run_url": "https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22076329719",
