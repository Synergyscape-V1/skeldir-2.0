...
- **Candidate SHA:** `5f116178679f54242cb62f71f3beb39fa3452d40`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22732313521
- **Generated at:** `2026-03-05T19:16:28.768255+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-05T19:07:44.999725+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.356,
  "latency_p95_ms": 2.979,
...
```json
{
  ...
  "latency_p50_ms": 9.055,
  "latency_p95_ms": 11.515,
  "latency_p99_ms": 15.273,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-05T19:10:28.659137+00:00",
  "window_start_utc": "2026-03-05T19:09:28.656239+00:00"
}
```
...
```json
{
  ...
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.51,
  "latency_p95_ms": 10.185,
  "latency_p99_ms": 13.406,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-05T19:11:28.732719+00:00",
  "window_start_utc": "2026-03-05T19:10:28.703589+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.986,
  "latency_p50_ms": 8.801,
  "latency_p95_ms": 10.9,
  "latency_p99_ms": 14.861,
  "latency_second_half_p95_ms": 10.863,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-05T19:16:28.619951+00:00",
  "window_start_utc": "2026-03-05T19:11:28.787583+00:00"
}
```
