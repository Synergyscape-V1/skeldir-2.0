...
- **Candidate SHA:** `87836b60cd2d8a23dcd6def203c14e3ae3b3477b`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33642859652
- **Generated at:** `2026-09-02T14:44:39.302805+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-02T14:35:01.980621+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.121,
  "latency_p95_ms": 5.579,
...
```json
{
  ...
  "latency_p50_ms": 27.111,
  "latency_p95_ms": 30.238,
  "latency_p99_ms": 36.617,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-02T14:38:39.143031+00:00",
  "window_start_utc": "2026-09-02T14:37:39.118389+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 30.693,
  "latency_p95_ms": 35.317,
  "latency_p99_ms": 43.364,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-02T14:39:39.233689+00:00",
  "window_start_utc": "2026-09-02T14:38:39.182293+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 33.498,
  "latency_p50_ms": 29.531,
  "latency_p95_ms": 32.394,
  "latency_p99_ms": 36.693,
  "latency_second_half_p95_ms": 31.66,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-02T14:44:39.136921+00:00",
  "window_start_utc": "2026-09-02T14:39:39.281770+00:00"
}
```
