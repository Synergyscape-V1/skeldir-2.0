...
- **Candidate SHA:** `f52a2704c05c1d3800e00e2be9bd4a17fca4a42f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23865525578
- **Generated at:** `2026-04-01T19:06:36.298310+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-01T18:57:31.937373+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.853,
  "latency_p95_ms": 18.44,
...
```json
{
  ...
  "latency_p50_ms": 18.054,
  "latency_p95_ms": 21.334,
  "latency_p99_ms": 32.019,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-01T19:00:36.179101+00:00",
  "window_start_utc": "2026-04-01T18:59:36.177209+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 17.063,
  "latency_p95_ms": 19.542,
  "latency_p99_ms": 22.242,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-01T19:01:36.243543+00:00",
  "window_start_utc": "2026-04-01T19:00:36.216513+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 20.509,
  "latency_p50_ms": 18.461,
  "latency_p95_ms": 20.095,
  "latency_p99_ms": 21.83,
  "latency_second_half_p95_ms": 19.062,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-01T19:06:36.128140+00:00",
  "window_start_utc": "2026-04-01T19:01:36.287035+00:00"
}
```
