...
- **Candidate SHA:** `6e224cc2889eab66665e81ef4c9d880e959d52fd`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23986013368
- **Generated at:** `2026-04-04T19:42:15.809339+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-04T19:33:04.398473+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.897,
  "latency_p95_ms": 18.008,
...
```json
{
  ...
  "latency_p50_ms": 16.356,
  "latency_p95_ms": 19.197,
  "latency_p99_ms": 22.824,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-04T19:36:15.725214+00:00",
  "window_start_utc": "2026-04-04T19:35:15.722633+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 15.443,
  "latency_p95_ms": 17.362,
  "latency_p99_ms": 20.356,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-04T19:37:15.795247+00:00",
  "window_start_utc": "2026-04-04T19:36:15.759386+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 18.676,
  "latency_p50_ms": 16.962,
  "latency_p95_ms": 19.47,
  "latency_p99_ms": 24.056,
  "latency_second_half_p95_ms": 20.331,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-04T19:42:15.669028+00:00",
  "window_start_utc": "2026-04-04T19:37:15.836739+00:00"
}
```
