...
- **Candidate SHA:** `29bce1176d48ed25032b245161779ce20e502a0f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22527714399
- **Generated at:** `2026-02-28T19:54:41.817423+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-28T19:45:53.244243+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.938,
  "latency_p95_ms": 2.499,
...
```json
{
  ...
  "latency_p50_ms": 7.204,
  "latency_p95_ms": 7.93,
  "latency_p99_ms": 9.271,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-28T19:48:41.677482+00:00",
  "window_start_utc": "2026-02-28T19:47:41.675765+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.256,
  "latency_p95_ms": 8.753,
  "latency_p99_ms": 10.064,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-28T19:49:41.763271+00:00",
  "window_start_utc": "2026-02-28T19:48:41.729385+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.242,
  "latency_p50_ms": 8.413,
  "latency_p95_ms": 9.549,
  "latency_p99_ms": 10.561,
  "latency_second_half_p95_ms": 9.698,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-28T19:54:41.659977+00:00",
  "window_start_utc": "2026-02-28T19:49:41.826199+00:00"
}
```
