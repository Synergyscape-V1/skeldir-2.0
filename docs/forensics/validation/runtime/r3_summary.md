...
- **Candidate SHA:** `1c260b7542874fe6c44e860107f8431f07bd183f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32170665418
- **Generated at:** `2026-08-18T18:32:49.922580+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-18T18:23:28.656413+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.078,
  "latency_p95_ms": 19.982,
...
```json
{
  ...
  "latency_p50_ms": 22.214,
  "latency_p95_ms": 25.038,
  "latency_p99_ms": 29.154,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-18T18:26:49.780732+00:00",
  "window_start_utc": "2026-08-18T18:25:49.765459+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 21.482,
  "latency_p95_ms": 25.093,
  "latency_p99_ms": 30.395,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-18T18:27:49.859880+00:00",
  "window_start_utc": "2026-08-18T18:26:49.818567+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.295,
  "latency_p50_ms": 22.535,
  "latency_p95_ms": 24.182,
  "latency_p99_ms": 26.84,
  "latency_second_half_p95_ms": 23.987,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-18T18:32:49.751530+00:00",
  "window_start_utc": "2026-08-18T18:27:49.905513+00:00"
}
```
