...
- **Candidate SHA:** `601e05f0f814c0b59ffe085ee3f05f6669eee1b5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31341657522
- **Generated at:** `2026-08-09T23:32:27.218634+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-09T23:23:06.409555+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.551,
  "latency_p95_ms": 4.721,
...
```json
{
  ...
  "latency_p50_ms": 23.959,
  "latency_p95_ms": 26.097,
  "latency_p99_ms": 30.885,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-09T23:26:27.050900+00:00",
  "window_start_utc": "2026-08-09T23:25:27.029508+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 24.286,
  "latency_p95_ms": 26.973,
  "latency_p99_ms": 31.708,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-09T23:27:27.149273+00:00",
  "window_start_utc": "2026-08-09T23:26:27.092210+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.313,
  "latency_p50_ms": 23.618,
  "latency_p95_ms": 25.313,
  "latency_p99_ms": 27.943,
  "latency_second_half_p95_ms": 25.322,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-09T23:32:27.043990+00:00",
  "window_start_utc": "2026-08-09T23:27:27.196987+00:00"
}
```
