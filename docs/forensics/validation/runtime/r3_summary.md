...
- **Candidate SHA:** `4853d4fb7e9d79e2d73fcc78afdaeadf85178afe`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26370932902
- **Generated at:** `2026-05-24T19:52:59.758512+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-24T19:43:38.934349+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.983,
  "latency_p95_ms": 10.642,
...
```json
{
  ...
  "latency_p50_ms": 20.489,
  "latency_p95_ms": 24.484,
  "latency_p99_ms": 26.907,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-24T19:46:59.633729+00:00",
  "window_start_utc": "2026-05-24T19:45:59.619629+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.656,
  "latency_p95_ms": 24.453,
  "latency_p99_ms": 28.135,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-24T19:47:59.708886+00:00",
  "window_start_utc": "2026-05-24T19:46:59.670082+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.099,
  "latency_p50_ms": 22.09,
  "latency_p95_ms": 23.849,
  "latency_p99_ms": 26.462,
  "latency_second_half_p95_ms": 23.439,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-24T19:52:59.598452+00:00",
  "window_start_utc": "2026-05-24T19:47:59.752915+00:00"
}
```
