...
- **Candidate SHA:** `a4e091613a918ef2220e1cff6b6d0916e2a235bf`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24637347722
- **Generated at:** `2026-04-19T19:43:45.629114+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-19T19:34:37.037367+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.819,
  "latency_p95_ms": 18.237,
...
```json
{
  ...
  "latency_p50_ms": 16.038,
  "latency_p95_ms": 19.156,
  "latency_p99_ms": 21.144,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-19T19:37:45.529520+00:00",
  "window_start_utc": "2026-04-19T19:36:45.517258+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 14.851,
  "latency_p95_ms": 17.204,
  "latency_p99_ms": 19.533,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-19T19:38:45.603078+00:00",
  "window_start_utc": "2026-04-19T19:37:45.566939+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 21.435,
  "latency_p50_ms": 19.611,
  "latency_p95_ms": 21.097,
  "latency_p99_ms": 23.025,
  "latency_second_half_p95_ms": 20.789,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-19T19:43:45.482328+00:00",
  "window_start_utc": "2026-04-19T19:38:45.647594+00:00"
}
```
