...
- **Candidate SHA:** `9d04677a884d13ec28e53fdd3319d813e423c24c`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33285488933
- **Generated at:** `2026-08-30T01:33:01.840904+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-30T01:23:22.527977+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.498,
  "latency_p95_ms": 4.862,
...
```json
{
  ...
  "latency_p50_ms": 22.517,
  "latency_p95_ms": 24.999,
  "latency_p99_ms": 29.128,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-30T01:27:01.694165+00:00",
  "window_start_utc": "2026-08-30T01:26:01.664807+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 22.857,
  "latency_p95_ms": 25.87,
  "latency_p99_ms": 31.227,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-30T01:28:01.768649+00:00",
  "window_start_utc": "2026-08-30T01:27:01.733770+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.914,
  "latency_p50_ms": 23.269,
  "latency_p95_ms": 25.486,
  "latency_p99_ms": 28.156,
  "latency_second_half_p95_ms": 25.679,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-30T01:33:01.664056+00:00",
  "window_start_utc": "2026-08-30T01:28:01.813884+00:00"
}
```
