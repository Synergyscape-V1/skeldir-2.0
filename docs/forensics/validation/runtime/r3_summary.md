...
- **Candidate SHA:** `c18b2acdcd08b814d5d827bee196e4df710e0693`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/30714561001
- **Generated at:** `2026-08-01T19:31:41.927156+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-01T19:22:28.849967+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.639,
  "latency_p95_ms": 2.061,
...
```json
{
  ...
  "latency_p50_ms": 19.913,
  "latency_p95_ms": 22.764,
  "latency_p99_ms": 32.544,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-01T19:25:41.822101+00:00",
  "window_start_utc": "2026-08-01T19:24:41.823787+00:00"
}
```
...
```json
{
  ...
  "latency_p95_ms": 23.673,
  "latency_p99_ms": 35.979,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-01T19:26:41.898740+00:00",
  "window_start_utc": "2026-08-01T19:25:41.857738+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.694,
  "latency_p50_ms": 22.68,
  "latency_p95_ms": 25.468,
  "latency_p99_ms": 31.039,
  "latency_second_half_p95_ms": 25.446,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-01T19:31:41.783343+00:00",
  "window_start_utc": "2026-08-01T19:26:41.940064+00:00"
}
```
