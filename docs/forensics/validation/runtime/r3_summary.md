...
- **Candidate SHA:** `0ccc050f73ef2a65d892eb31da6f38e5b7b3207d`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35246666541
- **Generated at:** `2026-09-17T16:37:41.904514+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-17T16:28:29.830997+00:00`
...
```json
{
  ...
  "latency_p50_ms": 0.966,
  "latency_p95_ms": 9.697,
...
```json
{
  ...
  "latency_p50_ms": 14.412,
  "latency_p95_ms": 105.36,
  "latency_p99_ms": 190.64,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-17T16:31:41.557870+00:00",
  "window_start_utc": "2026-09-17T16:30:41.539180+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 24.328,
  "latency_p95_ms": 369.832,
  "latency_p99_ms": 549.593,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-17T16:32:41.966152+00:00",
  "window_start_utc": "2026-09-17T16:31:41.578267+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 109.555,
  "latency_p50_ms": 14.711,
  "latency_p95_ms": 121.812,
  "latency_p99_ms": 219.566,
  "latency_second_half_p95_ms": 136.003,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-17T16:37:41.816854+00:00",
  "window_start_utc": "2026-09-17T16:32:41.990627+00:00"
}
```
