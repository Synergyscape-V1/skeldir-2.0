...
- **Candidate SHA:** `7752a79d1f7052ec7f159a989127f2e262f55e91`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33448645761
- **Generated at:** `2026-08-31T23:08:53.414064+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-31T22:59:29.993978+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.151,
  "latency_p95_ms": 2.791,
...
```json
{
  ...
  "latency_p50_ms": 21.103,
  "latency_p95_ms": 23.037,
  "latency_p99_ms": 28.282,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-31T23:02:53.270354+00:00",
  "window_start_utc": "2026-08-31T23:01:53.254203+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 21.178,
  "latency_p95_ms": 24.109,
  "latency_p99_ms": 27.91,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-31T23:03:53.351686+00:00",
  "window_start_utc": "2026-08-31T23:02:53.308629+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.238,
  "latency_p50_ms": 22.721,
  "latency_p95_ms": 23.96,
  "latency_p99_ms": 26.658,
  "latency_second_half_p95_ms": 23.729,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-31T23:08:53.245885+00:00",
  "window_start_utc": "2026-08-31T23:03:53.398797+00:00"
}
```
