...
- **Candidate SHA:** `ad61c80d3192cc19bf8ed0544c04fbce05f01f7b`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22966484110
- **Generated at:** `2026-03-11T17:56:06.890820+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-11T17:47:11.664205+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.501,
  "latency_p95_ms": 3.057,
...
```json
{
  ...
  "latency_p50_ms": 8.269,
  "latency_p95_ms": 10.322,
  "latency_p99_ms": 11.754,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-11T17:50:06.778382+00:00",
  "window_start_utc": "2026-03-11T17:49:06.774720+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.649,
  "latency_p95_ms": 9.32,
  "latency_p99_ms": 10.482,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-11T17:51:06.853526+00:00",
  "window_start_utc": "2026-03-11T17:50:06.823689+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.3,
  "latency_p50_ms": 9.023,
  "latency_p95_ms": 10.159,
  "latency_p99_ms": 11.954,
  "latency_second_half_p95_ms": 9.903,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-11T17:56:06.742014+00:00",
  "window_start_utc": "2026-03-11T17:51:06.909922+00:00"
}
```
