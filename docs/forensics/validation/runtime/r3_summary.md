...
- **Candidate SHA:** `e4e3d627966558819f6438b8388eba627eec5019`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22328355200
- **Generated at:** `2026-02-23T23:04:22.793397+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-23T22:55:35.056441+00:00`
...
```json
{
  ...
  "latency_p50_ms": 7.435,
  "latency_p95_ms": 8.703,
  "latency_p99_ms": 9.906,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-23T22:58:22.669407+00:00",
  "window_start_utc": "2026-02-23T22:57:22.666818+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.041,
  "latency_p95_ms": 7.725,
  "latency_p99_ms": 9.324,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-23T22:59:22.745475+00:00",
  "window_start_utc": "2026-02-23T22:58:22.714357+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.269,
  "latency_p50_ms": 7.963,
  "latency_p95_ms": 9.331,
  "latency_p99_ms": 10.524,
  "latency_second_half_p95_ms": 9.36,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-23T23:04:22.637022+00:00",
  "window_start_utc": "2026-02-23T22:59:22.804146+00:00"
}
```
