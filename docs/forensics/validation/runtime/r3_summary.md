...
- **Candidate SHA:** `8e965befcf2018bc1a1c5129d5a7227afa8d729e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35672840834
- **Generated at:** `2026-09-22T00:50:43.429763+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-22T00:41:08.135639+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.054,
  "latency_p95_ms": 20.22,
...
```json
{
  ...
  "latency_p50_ms": 31.859,
  "latency_p95_ms": 35.91,
  "latency_p99_ms": 46.856,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-22T00:44:43.241888+00:00",
  "window_start_utc": "2026-09-22T00:43:43.213931+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 36.672,
  "latency_p95_ms": 42.58,
  "latency_p99_ms": 63.279,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-22T00:45:43.338826+00:00",
  "window_start_utc": "2026-09-22T00:44:43.281556+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 35.882,
  "latency_p50_ms": 33.77,
  "latency_p95_ms": 36.049,
  "latency_p99_ms": 41.38,
  "latency_second_half_p95_ms": 36.137,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-22T00:50:43.243751+00:00",
  "window_start_utc": "2026-09-22T00:45:43.383941+00:00"
}
```
