...
- **Candidate SHA:** `9656025f911517c6b4702e6e474ea92f282fe64d`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25801300960
- **Generated at:** `2026-05-13T13:22:09.106655+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-13T13:12:51.238619+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.005,
  "latency_p95_ms": 5.232,
...
```json
{
  ...
  "latency_p50_ms": 19.133,
  "latency_p95_ms": 22.142,
  "latency_p99_ms": 24.833,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-13T13:16:08.974514+00:00",
  "window_start_utc": "2026-05-13T13:15:08.960421+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 18.858,
  "latency_p95_ms": 21.933,
  "latency_p99_ms": 25.599,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-13T13:17:09.053889+00:00",
  "window_start_utc": "2026-05-13T13:16:09.011364+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 22.105,
  "latency_p50_ms": 20.676,
  "latency_p95_ms": 22.574,
  "latency_p99_ms": 24.988,
  "latency_second_half_p95_ms": 22.884,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-13T13:22:08.949275+00:00",
  "window_start_utc": "2026-05-13T13:17:09.101749+00:00"
}
```
