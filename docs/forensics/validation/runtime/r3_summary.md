...
- **Candidate SHA:** `01108b473008b4147f86d8eac24112eecae9db15`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26190954074
- **Generated at:** `2026-05-20T21:36:59.890302+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-20T21:27:36.996237+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.999,
  "latency_p95_ms": 2.957,
...
```json
{
  ...
  "latency_p50_ms": 21.599,
  "latency_p95_ms": 26.989,
  "latency_p99_ms": 35.09,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-20T21:30:59.750277+00:00",
  "window_start_utc": "2026-05-20T21:29:59.733161+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 23.838,
  "latency_p95_ms": 37.87,
  "latency_p99_ms": 44.106,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-20T21:31:59.832519+00:00",
  "window_start_utc": "2026-05-20T21:30:59.790081+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 26.08,
  "latency_p50_ms": 22.156,
  "latency_p95_ms": 25.479,
  "latency_p99_ms": 28.156,
  "latency_second_half_p95_ms": 24.75,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-20T21:36:59.728224+00:00",
  "window_start_utc": "2026-05-20T21:31:59.883894+00:00"
}
```
