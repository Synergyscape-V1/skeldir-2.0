...
- **Candidate SHA:** `ca22d9d4d2f6dc095e478520004cb8fa1ae7bf15`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23270077698
- **Generated at:** `2026-03-18T22:35:26.802618+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-18T22:26:32.483968+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.006,
  "latency_p95_ms": 2.569,
...
```json
{
  ...
  "latency_p50_ms": 8.338,
  "latency_p95_ms": 9.719,
  "latency_p99_ms": 10.591,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-18T22:29:26.713971+00:00",
  "window_start_utc": "2026-03-18T22:28:26.710118+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.603,
  "latency_p95_ms": 8.376,
  "latency_p99_ms": 9.308,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-18T22:30:26.780932+00:00",
  "window_start_utc": "2026-03-18T22:29:26.751128+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.605,
  "latency_p50_ms": 8.196,
  "latency_p95_ms": 9.631,
  "latency_p99_ms": 10.535,
  "latency_second_half_p95_ms": 9.678,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-18T22:35:26.656330+00:00",
  "window_start_utc": "2026-03-18T22:30:26.823148+00:00"
}
```
