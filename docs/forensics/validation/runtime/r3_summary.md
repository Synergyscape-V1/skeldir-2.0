...
- **Candidate SHA:** `85d7789b2bfff6847721ae2ea428733f83969747`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26775040104
- **Generated at:** `2026-06-01T19:01:54.400478+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-01T18:52:30.670809+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.201,
  "latency_p95_ms": 3.163,
...
```json
{
  ...
  "latency_p50_ms": 21.437,
  "latency_p95_ms": 23.582,
  "latency_p99_ms": 27.669,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-01T18:55:54.261676+00:00",
  "window_start_utc": "2026-06-01T18:54:54.245133+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.239,
  "latency_p95_ms": 24.427,
  "latency_p99_ms": 29.368,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-01T18:56:54.347310+00:00",
  "window_start_utc": "2026-06-01T18:55:54.302258+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.202,
  "latency_p50_ms": 21.788,
  "latency_p95_ms": 24.516,
  "latency_p99_ms": 27.039,
  "latency_second_half_p95_ms": 24.636,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-01T19:01:54.241783+00:00",
  "window_start_utc": "2026-06-01T18:56:54.393671+00:00"
}
```
