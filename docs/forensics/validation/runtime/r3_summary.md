...
- **Candidate SHA:** `c4023837448af7747783cd8ac03091b936f9206e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28457033590
- **Generated at:** `2026-06-30T15:55:28.521956+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-30T15:45:53.495481+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.292,
  "latency_p95_ms": 3.042,
...
```json
{
  ...
  "latency_p50_ms": 20.746,
  "latency_p95_ms": 26.084,
  "latency_p99_ms": 29.367,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-30T15:49:28.359557+00:00",
  "window_start_utc": "2026-06-30T15:48:28.342724+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.128,
  "latency_p95_ms": 26.094,
  "latency_p99_ms": 30.107,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-30T15:50:28.443276+00:00",
  "window_start_utc": "2026-06-30T15:49:28.398485+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 26.045,
  "latency_p50_ms": 22.343,
  "latency_p95_ms": 25.806,
  "latency_p99_ms": 29.271,
  "latency_second_half_p95_ms": 25.545,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-30T15:55:28.340217+00:00",
  "window_start_utc": "2026-06-30T15:50:28.491482+00:00"
}
```
