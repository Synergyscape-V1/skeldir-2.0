...
- **Candidate SHA:** `26bcfc22018c69b35cd21fb59f58aa541124c75d`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26899906052
- **Generated at:** `2026-06-03T17:05:49.909216+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-03T16:56:33.029327+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.076,
  "latency_p95_ms": 2.788,
...
```json
{
  ...
  "latency_p50_ms": 20.723,
  "latency_p95_ms": 24.031,
  "latency_p99_ms": 30.421,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-03T16:59:49.764124+00:00",
  "window_start_utc": "2026-06-03T16:58:49.746806+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.019,
  "latency_p95_ms": 23.114,
  "latency_p99_ms": 27.631,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-03T17:00:49.848786+00:00",
  "window_start_utc": "2026-06-03T16:59:49.802230+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.474,
  "latency_p50_ms": 21.458,
  "latency_p95_ms": 23.984,
  "latency_p99_ms": 28.11,
  "latency_second_half_p95_ms": 24.514,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-03T17:05:49.751460+00:00",
  "window_start_utc": "2026-06-03T17:00:49.894791+00:00"
}
```
