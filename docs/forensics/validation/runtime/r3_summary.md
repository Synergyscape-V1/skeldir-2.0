...
- **Candidate SHA:** `70445f6170e4f8d528bc913e1f8abf2b2b76b5e4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34802350999
- **Generated at:** `2026-09-14T03:32:42.863264+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-14T03:23:05.172843+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.652,
  "latency_p95_ms": 46.892,
...
```json
{
  ...
  "latency_p50_ms": 30.664,
  "latency_p95_ms": 36.119,
  "latency_p99_ms": 42.2,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-14T03:26:42.667204+00:00",
  "window_start_utc": "2026-09-14T03:25:42.638844+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 37.292,
  "latency_p95_ms": 53.138,
  "latency_p99_ms": 63.774,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-14T03:27:42.766858+00:00",
  "window_start_utc": "2026-09-14T03:26:42.707531+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 36.555,
  "latency_p50_ms": 31.385,
  "latency_p95_ms": 36.085,
  "latency_p99_ms": 39.026,
  "latency_second_half_p95_ms": 35.943,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-14T03:32:42.676850+00:00",
  "window_start_utc": "2026-09-14T03:27:42.816328+00:00"
}
```
