...
- **Candidate SHA:** `1bf1c130c4c6aa43edf2e34ca9dc7657f8c59a7a`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22980334359
- **Generated at:** `2026-03-12T00:15:16.205946+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-12T00:06:26.039232+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.059,
  "latency_p95_ms": 2.653,
...
```json
{
  ...
  "latency_p50_ms": 8.602,
  "latency_p95_ms": 9.982,
  "latency_p99_ms": 11.03,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-12T00:09:16.073927+00:00",
  "window_start_utc": "2026-03-12T00:08:16.069517+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.143,
  "latency_p95_ms": 9.476,
  "latency_p99_ms": 10.764,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-12T00:10:16.153071+00:00",
  "window_start_utc": "2026-03-12T00:09:16.121212+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.252,
  "latency_p50_ms": 9.348,
  "latency_p95_ms": 10.156,
  "latency_p99_ms": 11.308,
  "latency_second_half_p95_ms": 10.056,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-12T00:15:16.046254+00:00",
  "window_start_utc": "2026-03-12T00:10:16.211284+00:00"
}
```
