...
- **Candidate SHA:** `9113ecf64fcbb38c4e3ef328da3db28c3cf4c00f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33193568380
- **Generated at:** `2026-08-28T17:23:23.623406+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-28T17:14:07.995035+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.971,
  "latency_p95_ms": 2.444,
...
```json
{
  ...
  "latency_p50_ms": 20.561,
  "latency_p95_ms": 22.067,
  "latency_p99_ms": 25.983,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-28T17:17:23.497966+00:00",
  "window_start_utc": "2026-08-28T17:16:23.483641+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.181,
  "latency_p95_ms": 23.223,
  "latency_p99_ms": 27.886,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-28T17:18:23.561542+00:00",
  "window_start_utc": "2026-08-28T17:17:23.535273+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.28,
  "latency_p50_ms": 22.884,
  "latency_p95_ms": 24.135,
  "latency_p99_ms": 26.61,
  "latency_second_half_p95_ms": 23.938,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-28T17:23:23.453008+00:00",
  "window_start_utc": "2026-08-28T17:18:23.607380+00:00"
}
```
