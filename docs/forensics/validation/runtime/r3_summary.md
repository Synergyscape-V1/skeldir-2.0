...
- **Candidate SHA:** `c9cadc56dfbe29749932f20c1c5f36dc1fc1d5c5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26411875994
- **Generated at:** `2026-05-25T17:24:38.287144+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-25T17:15:11.564489+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.146,
  "latency_p95_ms": 3.859,
...
```json
{
  ...
  "latency_p50_ms": 21.2,
  "latency_p95_ms": 23.959,
  "latency_p99_ms": 26.545,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-25T17:18:38.173189+00:00",
  "window_start_utc": "2026-05-25T17:17:38.152621+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.866,
  "latency_p95_ms": 25.171,
  "latency_p99_ms": 28.1,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-25T17:19:38.245118+00:00",
  "window_start_utc": "2026-05-25T17:18:38.211460+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.939,
  "latency_p50_ms": 22.696,
  "latency_p95_ms": 24.492,
  "latency_p99_ms": 26.915,
  "latency_second_half_p95_ms": 24.006,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-25T17:24:38.128044+00:00",
  "window_start_utc": "2026-05-25T17:19:38.293223+00:00"
}
```
