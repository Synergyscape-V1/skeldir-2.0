...
- **Candidate SHA:** `0d1e1f7e703de0a28d920cf898d90b31ac6f43b4`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/21927684680
- **Generated at:** `2026-02-11T23:58:22.009486+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-11T23:49:41.406181+00:00`
...
```json
{
  ...
  "latency_p50_ms": 8.548,
  "latency_p95_ms": 9.728,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-11T23:52:21.877715+00:00",
  "window_start_utc": "2026-02-11T23:51:21.871242+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.875,
  "latency_p95_ms": 9.334,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-11T23:53:21.969032+00:00",
  "window_start_utc": "2026-02-11T23:52:21.923969+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.929,
  "latency_p50_ms": 8.501,
  "latency_p95_ms": 9.728,
  "latency_second_half_p95_ms": 8.942,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-11T23:58:21.861611+00:00",
  "window_start_utc": "2026-02-11T23:53:22.028331+00:00"
}
```
