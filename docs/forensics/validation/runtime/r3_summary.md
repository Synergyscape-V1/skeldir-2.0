...
- **Candidate SHA:** `669ddd991e2a981a2a46cc5bce1a772efe770e8c`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/22022486500
- **Generated at:** `2026-02-14T18:58:42.607662+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-14T18:50:01.405908+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.952,
  "latency_p95_ms": 2.498,
...
```json
{
  ...
  "latency_p50_ms": 7.647,
  "latency_p95_ms": 8.971,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-14T18:52:42.484174+00:00",
  "window_start_utc": "2026-02-14T18:51:42.480290+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.347,
  "latency_p95_ms": 8.114,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-14T18:53:42.560424+00:00",
  "window_start_utc": "2026-02-14T18:52:42.531397+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.962,
  "latency_p50_ms": 8.835,
  "latency_p95_ms": 9.887,
  "latency_second_half_p95_ms": 9.84,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-14T18:58:42.454296+00:00",
  "window_start_utc": "2026-02-14T18:53:42.620828+00:00"
}
```
