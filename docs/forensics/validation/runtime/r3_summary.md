...
- **Candidate SHA:** `465eca225ba906ef4e8818ca32b910952d47f3b6`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27072077897
- **Generated at:** `2026-06-06T19:55:19.803948+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-06T19:45:57.262986+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.112,
  "latency_p95_ms": 3.296,
...
```json
{
  ...
  "latency_p50_ms": 21.895,
  "latency_p95_ms": 24.529,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-06T19:49:19.647835+00:00",
  "window_start_utc": "2026-06-06T19:48:19.628511+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 24.142,
  "latency_p95_ms": 26.792,
  "latency_p99_ms": 32.516,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-06T19:50:19.737516+00:00",
  "window_start_utc": "2026-06-06T19:49:19.687202+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.611,
  "latency_p50_ms": 23.306,
  "latency_p95_ms": 25.13,
  "latency_p99_ms": 27.393,
  "latency_second_half_p95_ms": 25.735,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-06T19:55:19.636364+00:00",
  "window_start_utc": "2026-06-06T19:50:19.786266+00:00"
}
```
