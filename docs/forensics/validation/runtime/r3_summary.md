...
- **Candidate SHA:** `7cb3a45f81b4a9add4bbf48dd621a20aab47fcbb`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22827031311
- **Generated at:** `2026-03-08T18:31:21.342566+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-08T18:22:38.150563+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.975,
  "latency_p95_ms": 2.508,
...
```json
{
  ...
  "latency_p50_ms": 8.083,
  "latency_p95_ms": 9.031,
  "latency_p99_ms": 9.983,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-08T18:25:21.243221+00:00",
  "window_start_utc": "2026-03-08T18:24:21.242137+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.223,
  "latency_p95_ms": 8.314,
  "latency_p99_ms": 9.797,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-08T18:26:21.314870+00:00",
  "window_start_utc": "2026-03-08T18:25:21.287938+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.257,
  "latency_p50_ms": 8.398,
  "latency_p95_ms": 9.17,
  "latency_p99_ms": 10.341,
  "latency_second_half_p95_ms": 9.093,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-08T18:31:21.202581+00:00",
  "window_start_utc": "2026-03-08T18:26:21.371359+00:00"
}
```
