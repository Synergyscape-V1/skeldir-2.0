...
- **Candidate SHA:** `737db5849de16453b931c167f3c1b84a68093ec7`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33754400259
- **Generated at:** `2026-09-03T12:31:05.507276+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-03T12:21:22.258850+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.453,
  "latency_p95_ms": 46.407,
...
```json
{
  ...
  "latency_p50_ms": 28.26,
  "latency_p95_ms": 32.018,
  "latency_p99_ms": 38.552,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-03T12:25:05.349637+00:00",
  "window_start_utc": "2026-09-03T12:24:05.324146+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 31.824,
  "latency_p95_ms": 36.462,
  "latency_p99_ms": 46.64,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-03T12:26:05.440084+00:00",
  "window_start_utc": "2026-09-03T12:25:05.386043+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 33.67,
  "latency_p50_ms": 30.053,
  "latency_p95_ms": 33.281,
  "latency_p99_ms": 37.516,
  "latency_second_half_p95_ms": 32.767,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-03T12:31:05.341202+00:00",
  "window_start_utc": "2026-09-03T12:26:05.486303+00:00"
}
```
