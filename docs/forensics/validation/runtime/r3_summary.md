...
- **Candidate SHA:** `ad8c6e173ee14322bd4dfbfac293dc0d7a8edfff`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34881435422
- **Generated at:** `2026-09-14T18:43:46.216372+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-14T18:34:02.361712+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.599,
  "latency_p95_ms": 3.358,
...
```json
{
  ...
  "latency_p50_ms": 31.37,
  "latency_p95_ms": 36.209,
  "latency_p99_ms": 42.741,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-14T18:37:46.045453+00:00",
  "window_start_utc": "2026-09-14T18:36:46.017194+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 35.287,
  "latency_p95_ms": 50.758,
  "latency_p99_ms": 61.798,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-14T18:38:46.143739+00:00",
  "window_start_utc": "2026-09-14T18:37:46.087129+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 34.966,
  "latency_p50_ms": 30.303,
  "latency_p95_ms": 33.889,
  "latency_p99_ms": 37.902,
  "latency_second_half_p95_ms": 32.231,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-14T18:43:46.048438+00:00",
  "window_start_utc": "2026-09-14T18:38:46.192433+00:00"
}
```
