...
- **Candidate SHA:** `d0a556d9098882cea7ffcaf91a8c7d442042d288`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23380842049
- **Generated at:** `2026-03-21T13:45:30.555325+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-21T13:36:31.179924+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.033,
  "latency_p95_ms": 2.874,
...
```json
{
  ...
  "latency_p50_ms": 12.779,
  "latency_p95_ms": 15.175,
  "latency_p99_ms": 17.867,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-21T13:39:30.437328+00:00",
  "window_start_utc": "2026-03-21T13:38:30.429015+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 12.43,
  "latency_p95_ms": 14.456,
  "latency_p99_ms": 16.462,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-21T13:40:30.518375+00:00",
  "window_start_utc": "2026-03-21T13:39:30.477210+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 14.872,
  "latency_p50_ms": 14.182,
  "latency_p95_ms": 15.192,
  "latency_p99_ms": 17.378,
  "latency_second_half_p95_ms": 15.445,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-21T13:45:30.406063+00:00",
  "window_start_utc": "2026-03-21T13:40:30.566381+00:00"
}
```
