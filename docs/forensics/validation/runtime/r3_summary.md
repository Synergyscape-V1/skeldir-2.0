...
- **Candidate SHA:** `2ec78abce384ef824dbb259cbadff984c0e0b76c`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32907838243
- **Generated at:** `2026-08-25T22:58:11.227331+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-25T22:48:44.977421+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.339,
  "latency_p95_ms": 8.817,
...
```json
{
  ...
  "latency_p50_ms": 22.495,
  "latency_p95_ms": 25.404,
  "latency_p99_ms": 28.879,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-25T22:52:11.095936+00:00",
  "window_start_utc": "2026-08-25T22:51:11.075199+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 21.933,
  "latency_p95_ms": 25.352,
  "latency_p99_ms": 29.578,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-25T22:53:11.184609+00:00",
  "window_start_utc": "2026-08-25T22:52:11.135031+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.11,
  "latency_p50_ms": 22.76,
  "latency_p95_ms": 25.179,
  "latency_p99_ms": 29.171,
  "latency_second_half_p95_ms": 25.217,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-25T22:58:11.064721+00:00",
  "window_start_utc": "2026-08-25T22:53:11.229605+00:00"
}
```
