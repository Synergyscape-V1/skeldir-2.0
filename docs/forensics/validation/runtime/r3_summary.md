...
- **Candidate SHA:** `00a36c1f90cfc8952a3108c4740fee2d96ec7092`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25175599653
- **Generated at:** `2026-04-30T16:08:12.348723+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-30T15:58:55.208181+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.041,
  "latency_p95_ms": 2.555,
...
```json
{
  ...
  "latency_p50_ms": 18.473,
  "latency_p95_ms": 20.935,
  "latency_p99_ms": 22.767,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-30T16:02:12.235609+00:00",
  "window_start_utc": "2026-04-30T16:01:12.218891+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 17.966,
  "latency_p95_ms": 20.257,
  "latency_p99_ms": 24.224,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-30T16:03:12.316849+00:00",
  "window_start_utc": "2026-04-30T16:02:12.273106+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 21.388,
  "latency_p50_ms": 20.164,
  "latency_p95_ms": 21.647,
  "latency_p99_ms": 23.849,
  "latency_second_half_p95_ms": 21.91,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-30T16:08:12.197778+00:00",
  "window_start_utc": "2026-04-30T16:03:12.362903+00:00"
}
```
