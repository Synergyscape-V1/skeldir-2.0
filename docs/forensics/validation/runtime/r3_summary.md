...
- **Candidate SHA:** `c9dd402c7299a366183f0eeb69aa655cd66be017`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23148966217
- **Generated at:** `2026-03-16T14:41:17.658093+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-16T14:32:32.712714+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.512,
  "latency_p95_ms": 3.031,
...
```json
{
  ...
  "latency_p50_ms": 9.666,
  "latency_p95_ms": 10.701,
  "latency_p99_ms": 11.666,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-16T14:35:17.530472+00:00",
  "window_start_utc": "2026-03-16T14:34:17.525040+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 9.153,
  "latency_p95_ms": 10.276,
  "latency_p99_ms": 11.022,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-16T14:36:17.622611+00:00",
  "window_start_utc": "2026-03-16T14:35:17.569305+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.096,
  "latency_p50_ms": 9.413,
  "latency_p95_ms": 10.291,
  "latency_p99_ms": 10.928,
  "latency_second_half_p95_ms": 10.384,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-16T14:41:17.508081+00:00",
  "window_start_utc": "2026-03-16T14:36:17.673090+00:00"
}
```
