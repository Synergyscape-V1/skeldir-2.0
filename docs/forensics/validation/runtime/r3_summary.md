...
- **Candidate SHA:** `3e50b2ce099fba96b995c2bbe33a2119c7cd2490`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28562618073
- **Generated at:** `2026-07-02T03:21:41.462148+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-07-02T03:12:17.587272+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.189,
  "latency_p95_ms": 4.107,
...
```json
{
  ...
  "latency_p50_ms": 20.531,
  "latency_p95_ms": 24.577,
  "latency_p99_ms": 26.413,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-07-02T03:15:41.298613+00:00",
  "window_start_utc": "2026-07-02T03:14:41.277442+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.035,
  "latency_p95_ms": 25.334,
  "latency_p99_ms": 28.825,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-07-02T03:16:41.389275+00:00",
  "window_start_utc": "2026-07-02T03:15:41.340021+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.919,
  "latency_p50_ms": 22.342,
  "latency_p95_ms": 24.768,
  "latency_p99_ms": 27.147,
  "latency_second_half_p95_ms": 24.701,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-07-02T03:21:41.287612+00:00",
  "window_start_utc": "2026-07-02T03:16:41.438633+00:00"
}
```
