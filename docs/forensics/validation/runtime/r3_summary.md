...
- **Candidate SHA:** `d4ccb8165e8e3326ca671251907577422cf96214`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34046802382
- **Generated at:** `2026-09-06T17:02:50.992793+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-06T16:53:18.620575+00:00`
...
```json
{
  ...
  "latency_p50_ms": 26.495,
  "latency_p95_ms": 29.764,
  "latency_p99_ms": 34.687,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-06T16:56:50.815615+00:00",
  "window_start_utc": "2026-09-06T16:55:50.796730+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 29.122,
  "latency_p95_ms": 31.699,
  "latency_p99_ms": 38.931,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-06T16:57:50.900633+00:00",
  "window_start_utc": "2026-09-06T16:56:50.852933+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 31.19,
  "latency_p50_ms": 28.862,
  "latency_p95_ms": 32.012,
  "latency_p99_ms": 34.787,
  "latency_second_half_p95_ms": 32.255,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-06T17:02:50.802842+00:00",
  "window_start_utc": "2026-09-06T16:57:50.949380+00:00"
}
```
