...
- **Candidate SHA:** `ef9e9ea1c34f55b8861ba1f6a7b681d3fb6539a5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26786394833
- **Generated at:** `2026-06-01T22:52:01.188067+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-01T22:42:35.069168+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.305,
  "latency_p95_ms": 2.845,
...
```json
{
  ...
  "latency_p50_ms": 21.945,
  "latency_p95_ms": 24.314,
  "latency_p99_ms": 26.645,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-01T22:46:01.049474+00:00",
  "window_start_utc": "2026-06-01T22:45:01.029408+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 22.705,
  "latency_p95_ms": 25.126,
  "latency_p99_ms": 29.174,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-01T22:47:01.135313+00:00",
  "window_start_utc": "2026-06-01T22:46:01.089021+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.568,
  "latency_p50_ms": 22.594,
  "latency_p95_ms": 24.09,
  "latency_p99_ms": 27.182,
  "latency_second_half_p95_ms": 23.901,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-01T22:52:01.031341+00:00",
  "window_start_utc": "2026-06-01T22:47:01.183404+00:00"
}
```
