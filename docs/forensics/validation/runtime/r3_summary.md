...
- **Candidate SHA:** `9dc215eef55417a772e46d777d945d274cb970f7`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22529768616
- **Generated at:** `2026-02-28T22:00:28.259320+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-28T21:51:42.092453+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.116,
  "latency_p95_ms": 2.705,
...
```json
{
  ...
  "latency_p50_ms": 8.554,
  "latency_p95_ms": 10.134,
  "latency_p99_ms": 11.729,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-28T21:54:28.128439+00:00",
  "window_start_utc": "2026-02-28T21:53:28.122326+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.961,
  "latency_p95_ms": 9.658,
  "latency_p99_ms": 11.129,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-28T21:55:28.208314+00:00",
  "window_start_utc": "2026-02-28T21:54:28.177063+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.262,
  "latency_p50_ms": 9.009,
  "latency_p95_ms": 10.057,
  "latency_p99_ms": 11.524,
  "latency_second_half_p95_ms": 9.879,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-28T22:00:28.104757+00:00",
  "window_start_utc": "2026-02-28T21:55:28.270920+00:00"
}
```
