...
- **Candidate SHA:** `4e8979f1fcfafe463e520c0bf521451c1e81e1e5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34714274246
- **Generated at:** `2026-09-12T19:40:13.579365+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-12T19:30:36.550200+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.655,
  "latency_p95_ms": 3.517,
...
```json
{
  ...
  "latency_p50_ms": 30.903,
  "latency_p95_ms": 34.069,
  "latency_p99_ms": 43.528,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-12T19:34:13.383632+00:00",
  "window_start_utc": "2026-09-12T19:33:13.353965+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 33.497,
  "latency_p95_ms": 38.508,
  "latency_p99_ms": 57.446,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-12T19:35:13.482705+00:00",
  "window_start_utc": "2026-09-12T19:34:13.423189+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 35.058,
  "latency_p50_ms": 32.64,
  "latency_p95_ms": 36.116,
  "latency_p99_ms": 39.729,
  "latency_second_half_p95_ms": 36.517,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-12T19:40:13.389042+00:00",
  "window_start_utc": "2026-09-12T19:35:13.530437+00:00"
}
```
