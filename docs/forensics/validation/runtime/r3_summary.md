...
- **Candidate SHA:** `0ea68df558d9ae4240370722a89022ed0734c40e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22651130474
- **Generated at:** `2026-03-04T01:47:58.781527+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-04T01:39:10.529327+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.004,
  "latency_p95_ms": 2.591,
...
```json
{
  ...
  "latency_p50_ms": 7.959,
  "latency_p95_ms": 9.337,
  "latency_p99_ms": 10.172,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-04T01:41:58.661064+00:00",
  "window_start_utc": "2026-03-04T01:40:58.656604+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.363,
  "latency_p95_ms": 8.539,
  "latency_p99_ms": 9.216,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-04T01:42:58.738853+00:00",
  "window_start_utc": "2026-03-04T01:41:58.709131+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.505,
  "latency_p50_ms": 8.718,
  "latency_p95_ms": 9.472,
  "latency_p99_ms": 10.412,
  "latency_second_half_p95_ms": 9.432,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-04T01:47:58.628383+00:00",
  "window_start_utc": "2026-03-04T01:42:58.795383+00:00"
}
```
