...
- **Candidate SHA:** `b32f67572bd15362e39227ff6f485faf5140d80f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32597975971
- **Generated at:** `2026-08-22T21:06:09.751792+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-22T20:56:40.194199+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.126,
  "latency_p95_ms": 9.223,
...
```json
{
  ...
  "latency_p50_ms": 22.029,
  "latency_p95_ms": 23.617,
  "latency_p99_ms": 26.74,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-22T21:00:09.605613+00:00",
  "window_start_utc": "2026-08-22T20:59:09.589012+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 21.827,
  "latency_p95_ms": 25.754,
  "latency_p99_ms": 33.589,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-22T21:01:09.686831+00:00",
  "window_start_utc": "2026-08-22T21:00:09.643838+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.556,
  "latency_p50_ms": 23.708,
  "latency_p95_ms": 25.072,
  "latency_p99_ms": 28.389,
  "latency_second_half_p95_ms": 24.688,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-22T21:06:09.578732+00:00",
  "window_start_utc": "2026-08-22T21:01:09.731329+00:00"
}
```
