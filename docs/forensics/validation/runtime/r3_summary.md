...
- **Candidate SHA:** `d74b739aa93645a9af7d8e791db48e34365d2746`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28553410134
- **Generated at:** `2026-07-01T23:12:04.832099+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-07-01T23:02:51.637373+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.986,
  "latency_p95_ms": 9.661,
...
```json
{
  ...
  "latency_p50_ms": 20.558,
  "latency_p95_ms": 25.728,
  "latency_p99_ms": 28.077,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-07-01T23:06:04.694510+00:00",
  "window_start_utc": "2026-07-01T23:05:04.678250+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.826,
  "latency_p95_ms": 24.341,
  "latency_p99_ms": 27.928,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-07-01T23:07:04.770763+00:00",
  "window_start_utc": "2026-07-01T23:06:04.732439+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.66,
  "latency_p50_ms": 22.685,
  "latency_p95_ms": 24.264,
  "latency_p99_ms": 26.129,
  "latency_second_half_p95_ms": 24.673,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-07-01T23:12:04.661995+00:00",
  "window_start_utc": "2026-07-01T23:07:04.817192+00:00"
}
```
