...
- **Candidate SHA:** `a65083c08c0a632657ad94836e2f3ce459afb164`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23949456878
- **Generated at:** `2026-04-03T14:31:25.225375+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-03T14:22:07.721416+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.084,
  "latency_p95_ms": 71.773,
...
```json
{
  ...
  "latency_p50_ms": 16.752,
  "latency_p95_ms": 19.391,
  "latency_p99_ms": 26.54,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-03T14:25:25.097840+00:00",
  "window_start_utc": "2026-04-03T14:24:25.083787+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 15.937,
  "latency_p95_ms": 18.661,
  "latency_p99_ms": 25.386,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-03T14:26:25.177261+00:00",
  "window_start_utc": "2026-04-03T14:25:25.133996+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 19.162,
  "latency_p50_ms": 17.878,
  "latency_p95_ms": 19.618,
  "latency_p99_ms": 22.612,
  "latency_second_half_p95_ms": 20.062,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-03T14:31:25.066458+00:00",
  "window_start_utc": "2026-04-03T14:26:25.222754+00:00"
}
```
