...
- **Candidate SHA:** `cd9b4a307431460fe33d28b4d491a484ae549982`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25562672109
- **Generated at:** `2026-05-08T15:10:12.619403+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-08T15:00:21.395154+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.486,
  "latency_p95_ms": 14.671,
...
```json
{
  ...
  "latency_p50_ms": 28.068,
  "latency_p95_ms": 571.317,
  "latency_p99_ms": 938.754,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-08T15:04:11.429198+00:00",
  "window_start_utc": "2026-05-08T15:03:11.423608+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 87.334,
  "latency_p95_ms": 899.866,
  "latency_p99_ms": 1312.768,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-08T15:05:12.401654+00:00",
  "window_start_utc": "2026-05-08T15:04:11.458945+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 184.139,
  "latency_p50_ms": 18.205,
  "latency_p95_ms": 186.473,
  "latency_p99_ms": 343.192,
  "latency_second_half_p95_ms": 188.303,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-08T15:10:12.485952+00:00",
  "window_start_utc": "2026-05-08T15:05:12.648901+00:00"
}
```
