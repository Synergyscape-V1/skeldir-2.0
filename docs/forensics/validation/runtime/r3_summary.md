...
- **Candidate SHA:** `4a0167811427c87b246bf868396e5779169134bd`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28599188909
- **Generated at:** `2026-07-02T14:59:48.189794+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-07-02T14:50:19.972903+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.745,
  "latency_p95_ms": 4.246,
...
```json
{
  ...
  "latency_p50_ms": 24.012,
  "latency_p95_ms": 26.647,
  "latency_p99_ms": 29.679,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-07-02T14:53:48.031416+00:00",
  "window_start_utc": "2026-07-02T14:52:48.007650+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 24.106,
  "latency_p95_ms": 32.418,
  "latency_p99_ms": 40.632,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-07-02T14:54:48.121574+00:00",
  "window_start_utc": "2026-07-02T14:53:48.072871+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.938,
  "latency_p50_ms": 23.549,
  "latency_p95_ms": 25.696,
  "latency_p99_ms": 29.555,
  "latency_second_half_p95_ms": 25.273,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-07-02T14:59:48.019750+00:00",
  "window_start_utc": "2026-07-02T14:54:48.168487+00:00"
}
```
