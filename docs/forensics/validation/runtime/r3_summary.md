...
- **Candidate SHA:** `ccd4dc15294c5258d80899a62b800dbd37cf94f3`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26339146771
- **Generated at:** `2026-05-23T17:44:10.270285+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-23T17:34:52.032865+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.093,
  "latency_p95_ms": 2.669,
...
```json
{
  ...
  "latency_p50_ms": 20.021,
  "latency_p95_ms": 22.228,
  "latency_p99_ms": 26.883,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-23T17:38:10.175585+00:00",
  "window_start_utc": "2026-05-23T17:37:10.161506+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 18.314,
  "latency_p95_ms": 20.448,
  "latency_p99_ms": 25.073,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-23T17:39:10.251115+00:00",
  "window_start_utc": "2026-05-23T17:38:10.211771+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 21.879,
  "latency_p50_ms": 20.258,
  "latency_p95_ms": 21.879,
  "latency_p99_ms": 24.326,
  "latency_second_half_p95_ms": 21.889,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-23T17:44:10.136452+00:00",
  "window_start_utc": "2026-05-23T17:39:10.292613+00:00"
}
```
