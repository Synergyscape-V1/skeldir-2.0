...
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22640919376
- **Generated at:** `2026-03-03T20:28:29.711338+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-03T20:19:42.106179+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.931,
  "latency_p95_ms": 3.372,
...
```json
{
  ...
  "latency_p50_ms": 7.18,
  "latency_p95_ms": 7.836,
  "latency_p99_ms": 8.997,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-03T20:22:29.577681+00:00",
  "window_start_utc": "2026-03-03T20:21:29.576528+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.003,
  "latency_p95_ms": 7.648,
  "latency_p99_ms": 9.549,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-03T20:23:29.653489+00:00",
  "window_start_utc": "2026-03-03T20:22:29.625313+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.074,
  "latency_p50_ms": 7.508,
  "latency_p95_ms": 8.961,
  "latency_p99_ms": 10.017,
  "latency_second_half_p95_ms": 8.245,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-03T20:28:29.544857+00:00",
  "window_start_utc": "2026-03-03T20:23:29.713233+00:00"
}
```
