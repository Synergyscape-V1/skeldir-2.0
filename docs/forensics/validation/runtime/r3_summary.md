...
- **Candidate SHA:** `1baee864618a42aac7bccc6d07392a65805aadeb`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23448059297
- **Generated at:** `2026-03-23T16:35:06.566307+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-23T16:25:52.290923+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.955,
  "latency_p95_ms": 2.733,
...
```json
{
  ...
  "latency_p50_ms": 16.437,
  "latency_p95_ms": 18.844,
  "latency_p99_ms": 21.208,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-23T16:29:06.451106+00:00",
  "window_start_utc": "2026-03-23T16:28:06.437733+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 15.559,
  "latency_p95_ms": 17.863,
  "latency_p99_ms": 26.268,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-23T16:30:06.527967+00:00",
  "window_start_utc": "2026-03-23T16:29:06.488234+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 19.923,
  "latency_p50_ms": 17.696,
  "latency_p95_ms": 19.156,
  "latency_p99_ms": 22.755,
  "latency_second_half_p95_ms": 18.76,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-23T16:35:06.423302+00:00",
  "window_start_utc": "2026-03-23T16:30:06.571750+00:00"
}
```
