...
- **Candidate SHA:** `b99dca34185fa98e87f47e11f7fc5f20b721dc77`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32613607797
- **Generated at:** `2026-08-23T02:54:49.978062+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-23T02:45:27.051433+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.085,
  "latency_p95_ms": 2.502,
...
```json
{
  ...
  "latency_p50_ms": 19.917,
  "latency_p95_ms": 20.943,
  "latency_p99_ms": 24.795,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-23T02:48:49.869923+00:00",
  "window_start_utc": "2026-08-23T02:47:49.853500+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.748,
  "latency_p95_ms": 22.95,
  "latency_p99_ms": 28.053,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-23T02:49:49.937830+00:00",
  "window_start_utc": "2026-08-23T02:48:49.906222+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.219,
  "latency_p50_ms": 20.568,
  "latency_p95_ms": 24.028,
  "latency_p99_ms": 26.133,
  "latency_second_half_p95_ms": 23.702,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-23T02:54:49.814293+00:00",
  "window_start_utc": "2026-08-23T02:49:49.980548+00:00"
}
```
