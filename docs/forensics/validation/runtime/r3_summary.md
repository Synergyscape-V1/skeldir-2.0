...
- **Candidate SHA:** `fc511708032f46fa5a76d2ebd969e3526412dff8`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23817115155
- **Generated at:** `2026-03-31T20:18:39.337101+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-31T20:09:18.428830+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.249,
  "latency_p95_ms": 12.551,
...
```json
{
  ...
  "latency_p50_ms": 17.567,
  "latency_p95_ms": 20.014,
  "latency_p99_ms": 24.184,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-31T20:12:39.247825+00:00",
  "window_start_utc": "2026-03-31T20:11:39.234389+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 16.773,
  "latency_p95_ms": 18.963,
  "latency_p99_ms": 22.037,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-31T20:13:39.313726+00:00",
  "window_start_utc": "2026-03-31T20:12:39.283500+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 20.101,
  "latency_p50_ms": 17.723,
  "latency_p95_ms": 20.051,
  "latency_p99_ms": 23.942,
  "latency_second_half_p95_ms": 19.954,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-31T20:18:39.198197+00:00",
  "window_start_utc": "2026-03-31T20:13:39.356638+00:00"
}
```
