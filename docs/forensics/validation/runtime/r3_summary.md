...
- **Candidate SHA:** `98d210c9e034b3f2c4ac2d85a887f83b6371d13e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32195828718
- **Generated at:** `2026-08-18T23:18:37.499590+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-18T23:09:18.672891+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.082,
  "latency_p95_ms": 2.847,
...
```json
{
  ...
  "latency_p50_ms": 19.71,
  "latency_p95_ms": 20.584,
  "latency_p99_ms": 23.895,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-18T23:12:37.371249+00:00",
  "window_start_utc": "2026-08-18T23:11:37.355166+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.51,
  "latency_p95_ms": 20.527,
  "latency_p99_ms": 26.776,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-18T23:13:37.449458+00:00",
  "window_start_utc": "2026-08-18T23:12:37.407991+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 21.647,
  "latency_p50_ms": 19.957,
  "latency_p95_ms": 21.996,
  "latency_p99_ms": 24.256,
  "latency_second_half_p95_ms": 22.092,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-18T23:18:37.338083+00:00",
  "window_start_utc": "2026-08-18T23:13:37.494280+00:00"
}
```
