...
- **Candidate SHA:** `c6c27be0072a1664d241faa539cc3ff5d206627e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28039058385
- **Generated at:** `2026-06-23T16:11:30.989989+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-23T16:02:01.734711+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.157,
  "latency_p95_ms": 5.269,
...
```json
{
  ...
  "latency_p50_ms": 22.737,
  "latency_p95_ms": 28.922,
  "latency_p99_ms": 53.181,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-23T16:05:30.852579+00:00",
  "window_start_utc": "2026-06-23T16:04:30.830774+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 21.198,
  "latency_p95_ms": 35.101,
  "latency_p99_ms": 54.944,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-23T16:06:30.938168+00:00",
  "window_start_utc": "2026-06-23T16:05:30.893516+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 26.99,
  "latency_p50_ms": 22.697,
  "latency_p95_ms": 27.445,
  "latency_p99_ms": 44.576,
  "latency_second_half_p95_ms": 27.499,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-23T16:11:30.831432+00:00",
  "window_start_utc": "2026-06-23T16:06:30.984491+00:00"
}
```
