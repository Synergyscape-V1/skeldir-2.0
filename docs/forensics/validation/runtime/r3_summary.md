...
- **Candidate SHA:** `6b08af3194cdf99889c1de4c298e3d823823f154`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/21971741182
- **Generated at:** `2026-02-13T02:08:53.072381+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-13T02:00:13.829084+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.945,
  "latency_p95_ms": 2.486,
...
```json
{
  ...
  "latency_p50_ms": 7.046,
  "latency_p95_ms": 7.615,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-13T02:02:52.946447+00:00",
  "window_start_utc": "2026-02-13T02:01:52.943807+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 6.924,
  "latency_p95_ms": 7.651,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-13T02:03:53.034000+00:00",
  "window_start_utc": "2026-02-13T02:02:52.992209+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.165,
  "latency_p50_ms": 7.615,
  "latency_p95_ms": 9.019,
  "latency_second_half_p95_ms": 8.922,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-13T02:08:52.925107+00:00",
  "window_start_utc": "2026-02-13T02:03:53.092420+00:00"
}
```
