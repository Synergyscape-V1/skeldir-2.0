...
- **Candidate SHA:** `ff7dba09a5050a107560bfd4a5450d1b3cdfd494`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31385390266
- **Generated at:** `2026-08-10T12:04:36.152235+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-10T11:54:30.924316+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.961,
  "latency_p95_ms": 7.853,
...
```json
{
  "achieved_rps": 29.009,
  "attribution_events_raw_payload_hits": 0,
  "canonical_rows_for_all_profile_keys": 1132,
  "dead_events_raw_payload_hits": 0,
  "dlq_rows_for_all_profile_keys": 174,
  "duplicate_canonical_keys_in_window": 0,
  "duration_s": 60,
  "elapsed_s": 59.9809,
  "expected_canonical_rows_for_all_profile_keys": 1132,
  "expected_dlq_rows_for_all_profile_keys": 174,
  "http_connection_errors": 0,
  "http_error_count": 0,
  ...
  "window_canonical_rows": 1132,
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-10T11:58:36.024043+00:00",
  "window_start_utc": "2026-08-10T11:57:36.009499+00:00"
}
```
...
```json
{
  "achieved_rps": 45.991,
  "attribution_events_raw_payload_hits": 0,
  "canonical_rows_for_all_profile_keys": 1795,
  "dead_events_raw_payload_hits": 0,
  "dlq_rows_for_all_profile_keys": 276,
  "duplicate_canonical_keys_in_window": 0,
  "duration_s": 60,
  "elapsed_s": 60.0111,
  "expected_canonical_rows_for_all_profile_keys": 1795,
  "expected_dlq_rows_for_all_profile_keys": 276,
  "http_connection_errors": 0,
  "http_error_count": 0,
  "http_error_rate_percent": 0.0,
  "http_status_counts": {
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 28.734,
  "latency_p95_ms": 271.776,
  "latency_p99_ms": 443.243,
  "latency_second_half_p95_ms": null,
  "malformed_dlq_rows_created": 276,
  "no_degradation_over_time": true,
  "observed_request_count": 2760,
  "passed": true,
  "pii_canonical_rows_created": 276,
  "pii_dlq_rows_created": 0,
  "pii_key_hit_count_in_db": 0,
  "replay_canonical_rows_for_key": 1,
  "resource_snapshot_after": {
  ...
  "window_canonical_rows": 1795,
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-10T11:59:36.106457+00:00",
  "window_start_utc": "2026-08-10T11:58:36.061956+00:00"
}
```
...
```json
{
  "achieved_rps": 5.003,
  "attribution_events_raw_payload_hits": 0,
  "canonical_rows_for_all_profile_keys": 976,
  "dead_events_raw_payload_hits": 0,
  "dlq_rows_for_all_profile_keys": 150,
  "duplicate_canonical_keys_in_window": 0,
  "duration_s": 300,
  "elapsed_s": 299.8281,
  "expected_canonical_rows_for_all_profile_keys": 976,
  "expected_dlq_rows_for_all_profile_keys": 150,
  "http_connection_errors": 0,
  "http_error_count": 0,
  "http_error_rate_percent": 0.0,
  "http_status_counts": {
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 73.538,
  "latency_p50_ms": 25.674,
  "latency_p95_ms": 84.329,
  "latency_p99_ms": 163.965,
  "latency_second_half_p95_ms": 96.035,
  "malformed_dlq_rows_created": 150,
  "no_degradation_over_time": true,
  "observed_request_count": 1500,
  "passed": true,
  "pii_canonical_rows_created": 150,
  "pii_dlq_rows_created": 0,
  "pii_key_hit_count_in_db": 0,
  "replay_canonical_rows_for_key": 1,
  "resource_snapshot_after": {
  ...
  "window_canonical_rows": 976,
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-10T12:04:35.992134+00:00",
  "window_start_utc": "2026-08-10T11:59:36.146235+00:00"
}
```
