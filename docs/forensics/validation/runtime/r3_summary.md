...
- **Candidate SHA:** `248067af0cf747645189dc1d5944e4169570bada`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22925728335
- **Generated at:** `2026-03-10T21:55:21.459400+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-10T21:46:36.326376+00:00`
...
```json
{
  ...
  "latency_p95_ms": 10.609,
  "latency_p99_ms": 11.79,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-10T21:49:21.330516+00:00",
  "window_start_utc": "2026-03-10T21:48:21.326130+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.977,
  "latency_p95_ms": 10.684,
  "latency_p99_ms": 11.542,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-10T21:50:21.409246+00:00",
  "window_start_utc": "2026-03-10T21:49:21.376895+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.333,
  "latency_p50_ms": 9.322,
  "latency_p95_ms": 10.355,
  "latency_p99_ms": 11.305,
  "latency_second_half_p95_ms": 10.423,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-10T21:55:21.304554+00:00",
  "window_start_utc": "2026-03-10T21:50:21.471000+00:00"
}
```
