...
- **Candidate SHA:** `3fbe1f8c862702e99e13cd2bad200b7875bfbf43`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26534225754
- **Generated at:** `2026-05-27T19:47:01.891971+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-27T19:37:53.445683+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.921,
  "latency_p95_ms": 12.323,
...
```json
{
  ...
  "latency_p50_ms": 19.88,
  "latency_p95_ms": 21.631,
  "latency_p99_ms": 25.696,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-27T19:41:01.734516+00:00",
  "window_start_utc": "2026-05-27T19:40:01.721539+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.386,
  "latency_p95_ms": 21.625,
  "latency_p99_ms": 26.955,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-27T19:42:01.808669+00:00",
  "window_start_utc": "2026-05-27T19:41:01.771481+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.7,
  "latency_p50_ms": 22.46,
  "latency_p95_ms": 24.564,
  "latency_p99_ms": 28.545,
  "latency_second_half_p95_ms": 25.064,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-27T19:47:01.714548+00:00",
  "window_start_utc": "2026-05-27T19:42:01.853899+00:00"
}
```
