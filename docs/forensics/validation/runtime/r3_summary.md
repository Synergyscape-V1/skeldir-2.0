...
- **Candidate SHA:** `0d15f12b9b060675663f5afdb9c29051b2eef974`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28475299677
- **Generated at:** `2026-06-30T21:07:26.349168+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-30T20:58:02.356438+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.115,
  "latency_p95_ms": 2.712,
...
```json
{
  ...
  "latency_p50_ms": 20.462,
  "latency_p95_ms": 23.655,
  "latency_p99_ms": 25.502,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-30T21:01:26.208600+00:00",
  "window_start_utc": "2026-06-30T21:00:26.190474+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.998,
  "latency_p95_ms": 23.76,
  "latency_p99_ms": 27.346,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-30T21:02:26.292267+00:00",
  "window_start_utc": "2026-06-30T21:01:26.249700+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.831,
  "latency_p50_ms": 22.253,
  "latency_p95_ms": 24.85,
  "latency_p99_ms": 26.187,
  "latency_second_half_p95_ms": 24.854,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-30T21:07:26.185569+00:00",
  "window_start_utc": "2026-06-30T21:02:26.338112+00:00"
}
```
