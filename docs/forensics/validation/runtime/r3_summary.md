...
- **Candidate SHA:** `1fbf51d1bec4b715abd88e0e649397a9f2da646a`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26849687175
- **Generated at:** `2026-06-02T21:52:07.066795+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-02T21:42:49.680440+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.015,
  "latency_p95_ms": 2.566,
...
```json
{
  ...
  "latency_p50_ms": 19.592,
  "latency_p95_ms": 21.128,
  "latency_p99_ms": 23.961,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-02T21:46:06.942584+00:00",
  "window_start_utc": "2026-06-02T21:45:06.938913+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.178,
  "latency_p95_ms": 21.158,
  "latency_p99_ms": 25.604,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-02T21:47:07.024873+00:00",
  "window_start_utc": "2026-06-02T21:46:06.982119+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 22.419,
  "latency_p50_ms": 20.495,
  "latency_p95_ms": 22.419,
  "latency_p99_ms": 24.921,
  "latency_second_half_p95_ms": 22.429,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-02T21:52:06.915028+00:00",
  "window_start_utc": "2026-06-02T21:47:07.069897+00:00"
}
```
