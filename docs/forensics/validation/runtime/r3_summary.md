...
- **Candidate SHA:** `262f65163310a575508fd247b454a2ada8ae91c7`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33124829364
- **Generated at:** `2026-08-27T23:12:47.865046+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-27T23:03:30.716743+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.073,
  "latency_p95_ms": 2.891,
...
```json
{
  ...
  "latency_p50_ms": 20.267,
  "latency_p95_ms": 22.402,
  "latency_p99_ms": 27.285,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-27T23:06:47.730610+00:00",
  "window_start_utc": "2026-08-27T23:05:47.713689+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.904,
  "latency_p95_ms": 22.832,
  "latency_p99_ms": 29.284,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-27T23:07:47.810556+00:00",
  "window_start_utc": "2026-08-27T23:06:47.767643+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.776,
  "latency_p50_ms": 21.89,
  "latency_p95_ms": 23.833,
  "latency_p99_ms": 26.454,
  "latency_second_half_p95_ms": 23.908,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-27T23:12:47.704538+00:00",
  "window_start_utc": "2026-08-27T23:07:47.856099+00:00"
}
```
