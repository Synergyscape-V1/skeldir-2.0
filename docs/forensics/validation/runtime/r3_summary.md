...
- **Candidate SHA:** `5999ef350044421e2acd4868b7bb62bf1a35b270`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35435398032
- **Generated at:** `2026-09-19T09:55:06.946989+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-19T09:45:40.101736+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.725,
  "latency_p95_ms": 18.129,
...
```json
{
  ...
  "latency_p50_ms": 28.846,
  "latency_p95_ms": 31.813,
  "latency_p99_ms": 37.323,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-19T09:49:06.846563+00:00",
  "window_start_utc": "2026-09-19T09:48:06.824911+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 32.356,
  "latency_p95_ms": 36.382,
  "latency_p99_ms": 45.598,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-19T09:50:06.934684+00:00",
  "window_start_utc": "2026-09-19T09:49:06.881800+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 35.093,
  "latency_p50_ms": 32.733,
  "latency_p95_ms": 34.881,
  "latency_p99_ms": 38.878,
  "latency_second_half_p95_ms": 34.599,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-19T09:55:06.807210+00:00",
  "window_start_utc": "2026-09-19T09:50:06.974430+00:00"
}
```
