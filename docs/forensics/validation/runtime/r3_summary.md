...
- **Candidate SHA:** `269e487ecc21deeee4d0890dd85db2b017fea7d1`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22598812556
- **Generated at:** `2026-03-02T22:42:37.895508+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-02T22:33:48.626805+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.577,
  "latency_p95_ms": 3.091,
...
```json
{
  ...
  "latency_p50_ms": 9.251,
  "latency_p95_ms": 10.262,
  "latency_p99_ms": 11.277,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-02T22:36:37.740329+00:00",
  "window_start_utc": "2026-03-02T22:35:37.734909+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 9.061,
  "latency_p95_ms": 10.275,
  "latency_p99_ms": 11.125,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-02T22:37:37.823260+00:00",
  "window_start_utc": "2026-03-02T22:36:37.790000+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.257,
  "latency_p50_ms": 9.333,
  "latency_p95_ms": 10.175,
  "latency_p99_ms": 11.52,
  "latency_second_half_p95_ms": 10.098,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-02T22:42:37.726451+00:00",
  "window_start_utc": "2026-03-02T22:37:37.888328+00:00"
}
```
