...
- **Candidate SHA:** `7679421d50f35306754848142ee4fb4815a79edc`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35034243922
- **Generated at:** `2026-09-15T23:18:46.518484+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-15T23:09:09.399379+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.614,
  "latency_p95_ms": 95.787,
...
```json
{
  ...
  "latency_p50_ms": 31.19,
  "latency_p95_ms": 35.59,
  "latency_p99_ms": 44.425,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-15T23:12:46.346961+00:00",
  "window_start_utc": "2026-09-15T23:11:46.317676+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 34.538,
  "latency_p95_ms": 39.295,
  "latency_p99_ms": 51.701,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-15T23:13:46.444545+00:00",
  "window_start_utc": "2026-09-15T23:12:46.388811+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 34.366,
  "latency_p50_ms": 30.666,
  "latency_p95_ms": 34.049,
  "latency_p99_ms": 37.299,
  "latency_second_half_p95_ms": 33.192,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-15T23:18:46.349762+00:00",
  "window_start_utc": "2026-09-15T23:13:46.493019+00:00"
}
```
