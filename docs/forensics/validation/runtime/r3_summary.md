...
- **Candidate SHA:** `d6dc7146776b7429be0d8257e3a10e52f9e79bc2`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23607141070
- **Generated at:** `2026-03-26T17:07:05.080927+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-26T16:57:46.096298+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.977,
  "latency_p95_ms": 2.925,
...
```json
{
  ...
  "latency_p50_ms": 16.916,
  "latency_p95_ms": 19.101,
  "latency_p99_ms": 28.512,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-26T17:01:04.954361+00:00",
  "window_start_utc": "2026-03-26T17:00:04.944727+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 16.586,
  "latency_p95_ms": 18.246,
  "latency_p99_ms": 23.71,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-26T17:02:05.032630+00:00",
  "window_start_utc": "2026-03-26T17:01:04.994000+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 19.511,
  "latency_p50_ms": 18.05,
  "latency_p95_ms": 19.224,
  "latency_p99_ms": 21.593,
  "latency_second_half_p95_ms": 18.987,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-26T17:07:04.918526+00:00",
  "window_start_utc": "2026-03-26T17:02:05.077586+00:00"
}
```
