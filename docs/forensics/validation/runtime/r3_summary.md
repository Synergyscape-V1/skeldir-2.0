...
- **Candidate SHA:** `0f6c2c28ac28e9fbb461721025755766e7f70127`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26405933526
- **Generated at:** `2026-05-25T14:49:08.991579+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-25T14:39:44.476905+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.044,
  "latency_p95_ms": 2.644,
...
```json
{
  ...
  "latency_p50_ms": 19.637,
  "latency_p95_ms": 22.486,
  "latency_p99_ms": 25.661,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-25T14:43:08.856003+00:00",
  "window_start_utc": "2026-05-25T14:42:08.836838+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.84,
  "latency_p95_ms": 24.674,
  "latency_p99_ms": 29.605,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-25T14:44:08.941580+00:00",
  "window_start_utc": "2026-05-25T14:43:08.897987+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.417,
  "latency_p50_ms": 22.264,
  "latency_p95_ms": 23.869,
  "latency_p99_ms": 27.647,
  "latency_second_half_p95_ms": 24.046,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-25T14:49:08.836362+00:00",
  "window_start_utc": "2026-05-25T14:44:08.988476+00:00"
}
```
