...
- **Candidate SHA:** `a866f6d088b251558b8a3d4552bc6a1119965129`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27148603497
- **Generated at:** `2026-06-08T15:43:05.617155+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-08T15:33:39.758717+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.218,
  "latency_p95_ms": 2.951,
...
```json
{
  ...
  "latency_p50_ms": 20.661,
  "latency_p95_ms": 22.915,
  "latency_p99_ms": 26.495,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-08T15:37:05.492089+00:00",
  "window_start_utc": "2026-06-08T15:36:05.475514+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.837,
  "latency_p95_ms": 23.376,
  "latency_p99_ms": 27.649,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-08T15:38:05.564094+00:00",
  "window_start_utc": "2026-06-08T15:37:05.532629+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.146,
  "latency_p50_ms": 22.178,
  "latency_p95_ms": 23.935,
  "latency_p99_ms": 26.197,
  "latency_second_half_p95_ms": 23.812,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-08T15:43:05.459132+00:00",
  "window_start_utc": "2026-06-08T15:38:05.610990+00:00"
}
```
