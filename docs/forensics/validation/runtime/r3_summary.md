...
- **Candidate SHA:** `b5206f52e02c304e2837a3f06494336b0cb1a0d4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25398410042
- **Generated at:** `2026-05-05T19:56:02.114511+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-05T19:46:49.587670+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.677,
  "latency_p95_ms": 3.784,
...
```json
{
  ...
  "latency_p50_ms": 17.289,
  "latency_p95_ms": 19.439,
  "latency_p99_ms": 25.906,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-05T19:50:02.038520+00:00",
  "window_start_utc": "2026-05-05T19:49:02.027978+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 16.074,
  "latency_p95_ms": 17.807,
  "latency_p99_ms": 19.298,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-05T19:51:02.099410+00:00",
  "window_start_utc": "2026-05-05T19:50:02.072976+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 20.153,
  "latency_p50_ms": 18.625,
  "latency_p95_ms": 20.032,
  "latency_p99_ms": 21.709,
  "latency_second_half_p95_ms": 19.933,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-05T19:56:01.983508+00:00",
  "window_start_utc": "2026-05-05T19:51:02.140815+00:00"
}
```
