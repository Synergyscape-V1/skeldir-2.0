...
- **Candidate SHA:** `d6b37c1c595beb6359b314fc743587647ef7431c`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28192905166
- **Generated at:** `2026-06-25T18:59:11.090829+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-25T18:49:45.254034+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.451,
  "latency_p95_ms": 3.543,
...
```json
{
  ...
  "latency_p50_ms": 24.066,
  "latency_p95_ms": 25.759,
  "latency_p99_ms": 30.027,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-25T18:53:10.926055+00:00",
  "window_start_utc": "2026-06-25T18:52:10.908755+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 24.654,
  "latency_p95_ms": 27.689,
  "latency_p99_ms": 33.221,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-25T18:54:11.011887+00:00",
  "window_start_utc": "2026-06-25T18:53:10.966680+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 27.007,
  "latency_p50_ms": 24.389,
  "latency_p95_ms": 26.261,
  "latency_p99_ms": 28.818,
  "latency_second_half_p95_ms": 25.424,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-25T18:59:10.909823+00:00",
  "window_start_utc": "2026-06-25T18:54:11.061283+00:00"
}
```
