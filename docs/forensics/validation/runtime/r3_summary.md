...
- **Candidate SHA:** `2cc031c29fea2e70eb1227b1d26eca8cc249e457`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/22042599718
- **Generated at:** `2026-02-15T20:43:05.808431+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-15T20:34:17.880724+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.675,
  "latency_p95_ms": 3.173,
...
```json
{
  ...
  "latency_p50_ms": 9.724,
  "latency_p95_ms": 10.921,
  "latency_p99_ms": 11.961,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-15T20:37:05.661568+00:00",
  "window_start_utc": "2026-02-15T20:36:05.640402+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.663,
  "latency_p95_ms": 10.101,
  "latency_p99_ms": 11.035,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-15T20:38:05.743574+00:00",
  "window_start_utc": "2026-02-15T20:37:05.707943+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.871,
  "latency_p50_ms": 9.251,
  "latency_p95_ms": 9.997,
  "latency_p99_ms": 10.702,
  "latency_second_half_p95_ms": 10.068,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-15T20:43:05.637148+00:00",
  "window_start_utc": "2026-02-15T20:38:05.801635+00:00"
}
```
