...
- **Candidate SHA:** `35c044c51b5b13154d385f0bd2a26e3c180e2b01`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28379844940
- **Generated at:** `2026-06-29T14:45:46.427737+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-29T14:36:16.742491+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.109,
  "latency_p95_ms": 3.023,
...
```json
{
  ...
  "latency_p50_ms": 20.094,
  "latency_p95_ms": 22.678,
  "latency_p99_ms": 25.823,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-29T14:39:46.293162+00:00",
  "window_start_utc": "2026-06-29T14:38:46.290765+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.546,
  "latency_p95_ms": 23.402,
  "latency_p99_ms": 27.82,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-29T14:40:46.375579+00:00",
  "window_start_utc": "2026-06-29T14:39:46.333617+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.823,
  "latency_p50_ms": 22.073,
  "latency_p95_ms": 23.558,
  "latency_p99_ms": 26.627,
  "latency_second_half_p95_ms": 23.317,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-29T14:45:46.269571+00:00",
  "window_start_utc": "2026-06-29T14:40:46.422197+00:00"
}
```
