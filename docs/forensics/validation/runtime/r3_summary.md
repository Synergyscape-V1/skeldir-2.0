...
- **Candidate SHA:** `c427d884f1ca5277c37dba6c4ad5a7357e43622b`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22915210013
- **Generated at:** `2026-03-10T17:29:28.303623+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-10T17:20:48.687433+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.966,
  "latency_p95_ms": 2.467,
...
```json
{
  ...
  "latency_p50_ms": 8.284,
  "latency_p95_ms": 9.119,
  "latency_p99_ms": 9.954,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-10T17:23:28.195489+00:00",
  "window_start_utc": "2026-03-10T17:22:28.193807+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.574,
  "latency_p95_ms": 8.605,
  "latency_p99_ms": 9.623,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-10T17:24:28.265332+00:00",
  "window_start_utc": "2026-03-10T17:23:28.238477+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.023,
  "latency_p50_ms": 8.443,
  "latency_p95_ms": 10.013,
  "latency_p99_ms": 11.446,
  "latency_second_half_p95_ms": 10.007,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-10T17:29:28.152819+00:00",
  "window_start_utc": "2026-03-10T17:24:28.319021+00:00"
}
```
