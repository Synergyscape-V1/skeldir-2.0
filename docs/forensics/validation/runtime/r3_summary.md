...
- **Candidate SHA:** `e98b6a065063235ff7eb25526ed4affec5e148cd`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23305159138
- **Generated at:** `2026-03-19T16:33:28.197858+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-19T16:24:37.995104+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.402,
  "latency_p95_ms": 3.093,
...
```json
{
  ...
  "latency_p50_ms": 9.936,
  "latency_p95_ms": 10.994,
  "latency_p99_ms": 12.174,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-19T16:27:28.073178+00:00",
  "window_start_utc": "2026-03-19T16:26:28.053230+00:00"
}
```
...
```json
{
  ...
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 9.5,
  "latency_p95_ms": 10.778,
  "latency_p99_ms": 11.788,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-19T16:28:28.146828+00:00",
  "window_start_utc": "2026-03-19T16:27:28.111507+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.771,
  "latency_p50_ms": 10.023,
  "latency_p95_ms": 10.837,
  "latency_p99_ms": 12.004,
  "latency_second_half_p95_ms": 10.883,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-19T16:33:28.031191+00:00",
  "window_start_utc": "2026-03-19T16:28:28.195576+00:00"
}
```
