...
- **Candidate SHA:** `d958d477a74d3150ead84aca171c11ffc61a06b0`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24394675339
- **Generated at:** `2026-04-14T10:54:30.204673+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-14T10:45:13.398239+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.379,
  "latency_p95_ms": 124.646,
...
```json
{
  ...
  "latency_p50_ms": 17.478,
  "latency_p95_ms": 21.567,
  "latency_p99_ms": 24.053,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-14T10:48:30.071599+00:00",
  "window_start_utc": "2026-04-14T10:47:30.056412+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 15.624,
  "latency_p95_ms": 18.283,
  "latency_p99_ms": 28.082,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-14T10:49:30.151771+00:00",
  "window_start_utc": "2026-04-14T10:48:30.111393+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 18.164,
  "latency_p50_ms": 16.163,
  "latency_p95_ms": 19.33,
  "latency_p99_ms": 20.551,
  "latency_second_half_p95_ms": 19.698,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-14T10:54:30.041034+00:00",
  "window_start_utc": "2026-04-14T10:49:30.197089+00:00"
}
```
