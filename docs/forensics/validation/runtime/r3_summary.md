...
- **Candidate SHA:** `6e8cc7f2ac2e59225cc5df10faa656e473c4c6c4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23315206113
- **Generated at:** `2026-03-19T20:31:38.133036+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-19T20:22:52.395647+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.774,
  "latency_p95_ms": 2.654,
...
```json
{
  ...
  "latency_p50_ms": 9.762,
  "latency_p95_ms": 11.049,
  "latency_p99_ms": 12.39,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-19T20:25:38.055024+00:00",
  "window_start_utc": "2026-03-19T20:24:38.050583+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.907,
  "latency_p95_ms": 10.045,
  "latency_p99_ms": 11.443,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-19T20:26:38.122060+00:00",
  "window_start_utc": "2026-03-19T20:25:38.092127+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 11.739,
  "latency_p50_ms": 10.435,
  "latency_p95_ms": 11.385,
  "latency_p99_ms": 13.131,
  "latency_second_half_p95_ms": 11.066,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-19T20:31:38.002740+00:00",
  "window_start_utc": "2026-03-19T20:26:38.168563+00:00"
}
```
