...
- **Candidate SHA:** `3a268b972275dd8532281e518d69ad2e11e831e5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26446734139
- **Generated at:** `2026-05-26T10:36:27.086788+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-26T10:27:03.464461+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.168,
  "latency_p95_ms": 3.228,
...
```json
{
  ...
  "latency_p50_ms": 21.274,
  "latency_p95_ms": 31.011,
  "latency_p99_ms": 39.381,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-26T10:30:26.931402+00:00",
  "window_start_utc": "2026-05-26T10:29:26.915028+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.438,
  "latency_p95_ms": 38.478,
  "latency_p99_ms": 47.746,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-26T10:31:27.005843+00:00",
  "window_start_utc": "2026-05-26T10:30:26.968889+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 30.063,
  "latency_p50_ms": 21.881,
  "latency_p95_ms": 31.801,
  "latency_p99_ms": 38.989,
  "latency_second_half_p95_ms": 32.97,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-26T10:36:26.906028+00:00",
  "window_start_utc": "2026-05-26T10:31:27.054522+00:00"
}
```
