...
- **Candidate SHA:** `d68af57c5d0d2383f007941884cb95de99d1fb8f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27479538195
- **Generated at:** `2026-06-13T21:34:48.416362+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-13T21:25:26.543857+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.447,
  "latency_p95_ms": 3.885,
...
```json
{
  ...
  "latency_p50_ms": 23.202,
  "latency_p95_ms": 25.771,
  "latency_p99_ms": 33.468,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-13T21:28:48.274331+00:00",
  "window_start_utc": "2026-06-13T21:27:48.270842+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 23.455,
  "latency_p95_ms": 30.235,
  "latency_p99_ms": 36.191,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-13T21:29:48.356172+00:00",
  "window_start_utc": "2026-06-13T21:28:48.313732+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.819,
  "latency_p50_ms": 22.704,
  "latency_p95_ms": 24.984,
  "latency_p99_ms": 29.405,
  "latency_second_half_p95_ms": 24.316,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-13T21:34:48.249390+00:00",
  "window_start_utc": "2026-06-13T21:29:48.402221+00:00"
}
```
