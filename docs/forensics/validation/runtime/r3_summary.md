...
- **Candidate SHA:** `9c9e1e46102cd764cf0b807c2ba7684de2a6a415`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/31733359405
- **Generated at:** `2026-08-13T19:08:56.117443+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-13T18:59:29.446525+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.242,
  "latency_p95_ms": 2.922,
...
```json
{
  ...
  "latency_p50_ms": 21.724,
  "latency_p95_ms": 25.455,
  "latency_p99_ms": 28.854,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-13T19:02:55.969246+00:00",
  "window_start_utc": "2026-08-13T19:01:55.949904+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 22.633,
  "latency_p95_ms": 25.403,
  "latency_p99_ms": 29.786,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-13T19:03:56.052906+00:00",
  "window_start_utc": "2026-08-13T19:02:56.008707+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.634,
  "latency_p50_ms": 23.35,
  "latency_p95_ms": 25.24,
  "latency_p99_ms": 27.797,
  "latency_second_half_p95_ms": 25.035,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-13T19:08:55.949200+00:00",
  "window_start_utc": "2026-08-13T19:03:56.099752+00:00"
}
```
