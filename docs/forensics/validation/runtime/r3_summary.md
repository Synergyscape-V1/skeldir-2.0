...
- **Candidate SHA:** `0e4479d19b6c67fb904dc3d4c265b624dc6b848b`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22770510668
- **Generated at:** `2026-03-06T15:51:45.223649+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-06T15:43:01.885118+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.234,
  "latency_p95_ms": 2.825,
...
```json
{
  ...
  "latency_p50_ms": 8.475,
  "latency_p95_ms": 9.979,
  "latency_p99_ms": 11.281,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-06T15:45:45.091358+00:00",
  "window_start_utc": "2026-03-06T15:44:45.074628+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.085,
  "latency_p95_ms": 9.86,
  "latency_p99_ms": 11.142,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-06T15:46:45.171357+00:00",
  "window_start_utc": "2026-03-06T15:45:45.141365+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.823,
  "latency_p50_ms": 8.894,
  "latency_p95_ms": 10.002,
  "latency_p99_ms": 11.049,
  "latency_second_half_p95_ms": 10.191,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-06T15:51:45.067093+00:00",
  "window_start_utc": "2026-03-06T15:46:45.234211+00:00"
}
```
