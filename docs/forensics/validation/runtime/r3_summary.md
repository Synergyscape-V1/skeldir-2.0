...
- **Candidate SHA:** `2c922212ddc93822b580ee5652ea11c2a25d3409`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27164129936
- **Generated at:** `2026-06-08T20:23:35.757979+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-08T20:14:17.117990+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.057,
  "latency_p95_ms": 16.871,
...
```json
{
  ...
  "latency_p50_ms": 20.338,
  "latency_p95_ms": 22.976,
  "latency_p99_ms": 26.382,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-08T20:17:35.628357+00:00",
  "window_start_utc": "2026-06-08T20:16:35.611494+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.694,
  "latency_p95_ms": 22.943,
  "latency_p99_ms": 27.432,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-08T20:18:35.710716+00:00",
  "window_start_utc": "2026-06-08T20:17:35.668087+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.332,
  "latency_p50_ms": 21.96,
  "latency_p95_ms": 24.007,
  "latency_p99_ms": 25.755,
  "latency_second_half_p95_ms": 23.804,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-08T20:23:35.604215+00:00",
  "window_start_utc": "2026-06-08T20:18:35.758552+00:00"
}
```
