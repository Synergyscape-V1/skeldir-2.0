...
- **Candidate SHA:** `08452e63c0f4660e7f0b0ad9c9aeabaae1c5da88`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35541611902
- **Generated at:** `2026-09-20T22:35:39.835985+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-20T22:25:45.082028+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.767,
  "latency_p95_ms": 13.606,
...
```json
{
  ...
  "latency_p50_ms": 38.542,
  "latency_p95_ms": 44.439,
  "latency_p99_ms": 52.147,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-20T22:29:39.630015+00:00",
  "window_start_utc": "2026-09-20T22:28:39.585889+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 41.693,
  "latency_p95_ms": 65.842,
  "latency_p99_ms": 93.995,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-20T22:30:39.743131+00:00",
  "window_start_utc": "2026-09-20T22:29:39.670442+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 40.056,
  "latency_p50_ms": 36.728,
  "latency_p95_ms": 40.969,
  "latency_p99_ms": 44.604,
  "latency_second_half_p95_ms": 41.549,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-20T22:35:39.656771+00:00",
  "window_start_utc": "2026-09-20T22:30:39.791190+00:00"
}
```
