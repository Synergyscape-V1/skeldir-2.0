...
- **Candidate SHA:** `c73455ced5c9cfd37c1f82f6070ba428d2edb8a4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32912372953
- **Generated at:** `2026-08-25T23:59:02.133990+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-25T23:49:32.850365+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.311,
  "latency_p95_ms": 2.855,
...
```json
{
  ...
  "latency_p50_ms": 22.013,
  "latency_p95_ms": 24.578,
  "latency_p99_ms": 27.858,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-25T23:53:01.972461+00:00",
  "window_start_utc": "2026-08-25T23:52:01.953765+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 22.873,
  "latency_p95_ms": 26.46,
  "latency_p99_ms": 30.751,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-25T23:54:02.061337+00:00",
  "window_start_utc": "2026-08-25T23:53:02.011653+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.078,
  "latency_p50_ms": 23.862,
  "latency_p95_ms": 25.864,
  "latency_p99_ms": 28.905,
  "latency_second_half_p95_ms": 26.096,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-25T23:59:01.957750+00:00",
  "window_start_utc": "2026-08-25T23:54:02.107328+00:00"
}
```
