...
- **Candidate SHA:** `ef5a2c3d6c1a4a4a534f7b9271b3c3ea85a4f39b`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22690765317
- **Generated at:** `2026-03-04T21:53:24.864070+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-04T21:44:39.871212+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.948,
  "latency_p95_ms": 2.596,
...
```json
{
  ...
  "latency_p50_ms": 7.611,
  "latency_p95_ms": 8.972,
  "latency_p99_ms": 9.796,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-04T21:47:24.743588+00:00",
  "window_start_utc": "2026-03-04T21:46:24.729620+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.248,
  "latency_p95_ms": 8.168,
  "latency_p99_ms": 10.658,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-04T21:48:24.819339+00:00",
  "window_start_utc": "2026-03-04T21:47:24.789325+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.285,
  "latency_p50_ms": 8.197,
  "latency_p95_ms": 9.302,
  "latency_p99_ms": 10.256,
  "latency_second_half_p95_ms": 9.349,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-04T21:53:24.712504+00:00",
  "window_start_utc": "2026-03-04T21:48:24.879498+00:00"
}
```
