...
- **Candidate SHA:** `6159fda7bc08a0940a7c198ecfc395da9c2a3604`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/29705608765
- **Generated at:** `2026-07-19T22:21:31.792861+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-07-19T22:12:03.191976+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.362,
  "latency_p95_ms": 3.029,
...
```json
{
  ...
  "latency_p50_ms": 23.034,
  "latency_p95_ms": 25.086,
  "latency_p99_ms": 29.14,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-07-19T22:15:31.649965+00:00",
  "window_start_utc": "2026-07-19T22:14:31.629006+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 23.984,
  "latency_p95_ms": 26.46,
  "latency_p99_ms": 30.829,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-07-19T22:16:31.727118+00:00",
  "window_start_utc": "2026-07-19T22:15:31.691997+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 25.797,
  "latency_p50_ms": 23.531,
  "latency_p95_ms": 25.57,
  "latency_p99_ms": 28.241,
  "latency_second_half_p95_ms": 25.328,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-07-19T22:21:31.623726+00:00",
  "window_start_utc": "2026-07-19T22:16:31.774171+00:00"
}
```
