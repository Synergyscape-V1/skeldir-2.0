...
- **Candidate SHA:** `913c05b281a9c4a52870798ff89b90afdfc0bf2a`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35126956433
- **Generated at:** `2026-09-16T17:25:11.966882+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-16T17:15:37.765402+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.088,
  "latency_p95_ms": 6.879,
...
```json
{
  ...
  "latency_p50_ms": 27.546,
  "latency_p95_ms": 33.314,
  "latency_p99_ms": 40.238,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-16T17:19:11.822114+00:00",
  "window_start_utc": "2026-09-16T17:18:11.801056+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 30.404,
  "latency_p95_ms": 34.502,
  "latency_p99_ms": 45.383,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-16T17:20:11.908647+00:00",
  "window_start_utc": "2026-09-16T17:19:11.859810+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 32.61,
  "latency_p50_ms": 29.813,
  "latency_p95_ms": 33.784,
  "latency_p99_ms": 39.439,
  "latency_second_half_p95_ms": 34.372,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-16T17:25:11.787417+00:00",
  "window_start_utc": "2026-09-16T17:20:11.954824+00:00"
}
```
