...
- **Candidate SHA:** `26f1650848060ecf9e894bf87a73cbbaeba8ee9e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24633225017
- **Generated at:** `2026-04-19T16:12:22.310577+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-19T16:02:54.351667+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.483,
  "latency_p95_ms": 2.032,
...
```json
{
  ...
  "latency_p50_ms": 13.51,
  "latency_p95_ms": 82.202,
  "latency_p99_ms": 170.754,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-19T16:06:22.264831+00:00",
  "window_start_utc": "2026-04-19T16:05:22.256965+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 14.609,
  "latency_p95_ms": 112.911,
  "latency_p99_ms": 319.433,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-19T16:07:22.318729+00:00",
  "window_start_utc": "2026-04-19T16:06:22.295017+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 77.155,
  "latency_p50_ms": 15.168,
  "latency_p95_ms": 70.939,
  "latency_p99_ms": 158.07,
  "latency_second_half_p95_ms": 63.674,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-19T16:12:22.181982+00:00",
  "window_start_utc": "2026-04-19T16:07:22.355559+00:00"
}
```
