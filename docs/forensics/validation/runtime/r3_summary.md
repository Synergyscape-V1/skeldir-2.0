...
- **Candidate SHA:** `58b35ecea14f86e22b7fe794bae605775b40951d`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28532297450
- **Generated at:** `2026-07-01T16:37:04.103583+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-07-01T16:27:41.470946+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.641,
  "latency_p95_ms": 11.217,
...
```json
{
  ...
  "latency_p50_ms": 19.657,
  "latency_p95_ms": 23.511,
  "latency_p99_ms": 25.763,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-07-01T16:31:03.974625+00:00",
  "window_start_utc": "2026-07-01T16:30:03.971310+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 18.926,
  "latency_p95_ms": 21.792,
  "latency_p99_ms": 27.552,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-07-01T16:32:04.054661+00:00",
  "window_start_utc": "2026-07-01T16:31:04.013567+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.379,
  "latency_p50_ms": 20.553,
  "latency_p95_ms": 23.032,
  "latency_p99_ms": 25.135,
  "latency_second_half_p95_ms": 22.737,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-07-01T16:37:03.946431+00:00",
  "window_start_utc": "2026-07-01T16:32:04.101692+00:00"
}
```
