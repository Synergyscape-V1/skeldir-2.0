...
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/21963198557
- **Generated at:** `2026-02-12T20:41:44.240252+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-02-12T20:32:57.314734+00:00`
...
```json
{
  ...
  "latency_p50_ms": 7.447,
  "latency_p95_ms": 8.254,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-02-12T20:35:44.125023+00:00",
  "window_start_utc": "2026-02-12T20:34:44.110961+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.151,
  "latency_p95_ms": 8.078,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-02-12T20:36:44.199544+00:00",
  "window_start_utc": "2026-02-12T20:35:44.168605+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.177,
  "latency_p50_ms": 8.17,
  "latency_p95_ms": 9.2,
  "latency_second_half_p95_ms": 9.247,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-02-12T20:41:44.090776+00:00",
  "window_start_utc": "2026-02-12T20:36:44.256427+00:00"
}
```
