...
- **Candidate SHA:** `982495e117d18711163102221ffbcfd1bdf90c8e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26754838347
- **Generated at:** `2026-06-01T12:38:13.493797+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-01T12:29:10.068128+00:00`
...
```json
{
  ...
  "latency_p50_ms": 0.948,
  "latency_p95_ms": 7.158,
...
```json
{
  ...
  "latency_p50_ms": 12.081,
  "latency_p95_ms": 109.264,
  "latency_p99_ms": 249.948,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-01T12:32:13.528603+00:00",
  "window_start_utc": "2026-06-01T12:31:13.532120+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 14.335,
  "latency_p95_ms": 60.383,
  "latency_p99_ms": 173.169,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-01T12:33:13.561275+00:00",
  "window_start_utc": "2026-06-01T12:32:13.549858+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 19.064,
  "latency_p50_ms": 11.145,
  "latency_p95_ms": 17.801,
  "latency_p99_ms": 72.744,
  "latency_second_half_p95_ms": 15.57,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-01T12:38:13.409764+00:00",
  "window_start_utc": "2026-06-01T12:33:13.586278+00:00"
}
```
