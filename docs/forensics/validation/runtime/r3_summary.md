...
- **Candidate SHA:** `1b3d3bb2b7cb36cf80d0761a78d92dbbb4c2dcf5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/28205429440
- **Generated at:** `2026-06-25T23:02:43.168789+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-25T22:53:22.579318+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.523,
  "latency_p95_ms": 19.408,
...
```json
{
  ...
  "latency_p50_ms": 25.213,
  "latency_p95_ms": 28.077,
  "latency_p99_ms": 32.993,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-25T22:56:43.004718+00:00",
  "window_start_utc": "2026-06-25T22:55:42.983110+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 26.628,
  "latency_p95_ms": 39.434,
  "latency_p99_ms": 49.856,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-25T22:57:43.097779+00:00",
  "window_start_utc": "2026-06-25T22:56:43.044925+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 29.73,
  "latency_p50_ms": 26.117,
  "latency_p95_ms": 29.148,
  "latency_p99_ms": 31.845,
  "latency_second_half_p95_ms": 28.192,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-25T23:02:42.995718+00:00",
  "window_start_utc": "2026-06-25T22:57:43.145393+00:00"
}
```
