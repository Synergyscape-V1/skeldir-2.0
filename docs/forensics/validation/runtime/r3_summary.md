...
- **Candidate SHA:** `f1a24b0e9b4bfe300ab1b78ecf33139b48bdb5dc`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27945177126
- **Generated at:** `2026-06-22T10:18:16.507223+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-22T10:09:02.713473+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.047,
  "latency_p95_ms": 6.121,
...
```json
{
  ...
  "latency_p50_ms": 21.975,
  "latency_p95_ms": 23.936,
  "latency_p99_ms": 27.044,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-22T10:12:16.380788+00:00",
  "window_start_utc": "2026-06-22T10:11:16.378439+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.933,
  "latency_p95_ms": 23.732,
  "latency_p99_ms": 30.36,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-22T10:13:16.467996+00:00",
  "window_start_utc": "2026-06-22T10:12:16.417993+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.014,
  "latency_p50_ms": 22.246,
  "latency_p95_ms": 24.093,
  "latency_p99_ms": 25.55,
  "latency_second_half_p95_ms": 24.156,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-22T10:18:16.361825+00:00",
  "window_start_utc": "2026-06-22T10:13:16.514633+00:00"
}
```
