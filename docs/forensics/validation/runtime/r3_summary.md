...
- **Candidate SHA:** `06bf68481fbbe97db93cc0e1e2f97f500e4255de`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/35479220808
- **Generated at:** `2026-09-20T00:47:56.069439+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-20T00:38:08.176835+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.247,
  "latency_p95_ms": 90.368,
...
```json
{
  ...
  "latency_p50_ms": 32.295,
  "latency_p95_ms": 39.684,
  "latency_p99_ms": 48.551,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-20T00:41:55.864722+00:00",
  "window_start_utc": "2026-09-20T00:40:55.825851+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 36.047,
  "latency_p95_ms": 44.024,
  "latency_p99_ms": 60.917,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-20T00:42:55.968020+00:00",
  "window_start_utc": "2026-09-20T00:41:55.902102+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 39.061,
  "latency_p50_ms": 34.929,
  "latency_p95_ms": 38.654,
  "latency_p99_ms": 43.44,
  "latency_second_half_p95_ms": 37.925,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-20T00:47:55.892485+00:00",
  "window_start_utc": "2026-09-20T00:42:56.026331+00:00"
}
```
