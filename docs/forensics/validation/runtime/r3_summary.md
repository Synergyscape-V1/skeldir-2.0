...
- **Candidate SHA:** `9e8b315e29d848925fdd3d033d0b3df18ca6a1d4`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/34734780155
- **Generated at:** `2026-09-13T03:19:51.179524+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-13T03:10:15.889917+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.274,
  "latency_p95_ms": 8.389,
...
```json
{
  ...
  "latency_p50_ms": 29.529,
  "latency_p95_ms": 33.456,
  "latency_p99_ms": 38.149,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-13T03:13:50.993964+00:00",
  "window_start_utc": "2026-09-13T03:12:50.966568+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 33.439,
  "latency_p95_ms": 49.045,
  "latency_p99_ms": 58.898,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-13T03:14:51.087920+00:00",
  "window_start_utc": "2026-09-13T03:13:51.035675+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 32.889,
  "latency_p50_ms": 30.629,
  "latency_p95_ms": 33.958,
  "latency_p99_ms": 36.157,
  "latency_second_half_p95_ms": 34.265,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-13T03:19:50.993207+00:00",
  "window_start_utc": "2026-09-13T03:14:51.137332+00:00"
}
```
