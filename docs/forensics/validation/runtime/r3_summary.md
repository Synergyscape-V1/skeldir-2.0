...
- **Candidate SHA:** `eb0f1227a8e4f95cc52707b16d0251d03c850942`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/32425451795
- **Generated at:** `2026-08-20T22:54:33.717535+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-20T22:45:06.297703+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.099,
  "latency_p95_ms": 4.394,
...
```json
{
  ...
  "latency_p50_ms": 20.2,
  "latency_p95_ms": 21.445,
  "latency_p99_ms": 24.236,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-20T22:48:33.583441+00:00",
  "window_start_utc": "2026-08-20T22:47:33.568700+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.91,
  "latency_p95_ms": 22.196,
  "latency_p99_ms": 28.194,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-20T22:49:33.664272+00:00",
  "window_start_utc": "2026-08-20T22:48:33.622484+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.303,
  "latency_p50_ms": 20.974,
  "latency_p95_ms": 23.296,
  "latency_p99_ms": 25.597,
  "latency_second_half_p95_ms": 23.296,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-20T22:54:33.555276+00:00",
  "window_start_utc": "2026-08-20T22:49:33.709626+00:00"
}
```
