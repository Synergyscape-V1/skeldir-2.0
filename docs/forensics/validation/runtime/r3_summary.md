...
- **Candidate SHA:** `a2c9176a04905dbd129007bd88aa57e047c2be5f`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24692438441
- **Generated at:** `2026-04-20T22:06:38.255437+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-20T21:57:20.358504+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.381,
  "latency_p95_ms": 4.758,
...
```json
{
  ...
  "latency_p50_ms": 20.242,
  "latency_p95_ms": 21.949,
  "latency_p99_ms": 23.8,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-20T22:00:38.131628+00:00",
  "window_start_utc": "2026-04-20T21:59:38.128242+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.67,
  "latency_p95_ms": 21.827,
  "latency_p99_ms": 24.777,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-20T22:01:38.203419+00:00",
  "window_start_utc": "2026-04-20T22:00:38.172946+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 21.298,
  "latency_p50_ms": 20.287,
  "latency_p95_ms": 21.682,
  "latency_p99_ms": 23.665,
  "latency_second_half_p95_ms": 21.923,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-20T22:06:38.084381+00:00",
  "window_start_utc": "2026-04-20T22:01:38.250810+00:00"
}
```
