...
- **Candidate SHA:** `bc00095969e6e44bcbbbfe8761af719914bbe8a7`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25074076672
- **Generated at:** `2026-04-28T19:56:56.852878+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-28T19:47:23.440748+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.111,
  "latency_p95_ms": 2.657,
...
```json
{
  ...
  "latency_p50_ms": 20.74,
  "latency_p95_ms": 23.018,
  "latency_p99_ms": 25.26,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-28T19:50:56.735183+00:00",
  "window_start_utc": "2026-04-28T19:49:56.721774+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.385,
  "latency_p95_ms": 23.054,
  "latency_p99_ms": 25.416,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-28T19:51:56.812767+00:00",
  "window_start_utc": "2026-04-28T19:50:56.773665+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 22.624,
  "latency_p50_ms": 21.401,
  "latency_p95_ms": 22.931,
  "latency_p99_ms": 25.813,
  "latency_second_half_p95_ms": 23.406,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-28T19:56:56.691120+00:00",
  "window_start_utc": "2026-04-28T19:51:56.858111+00:00"
}
```
