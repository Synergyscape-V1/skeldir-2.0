...
- **Candidate SHA:** `4682bd4a9bf9f88a21804b6d5f1dae7b58184bd5`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22907482304
- **Generated at:** `2026-03-10T14:38:00.223481+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-10T14:29:19.683343+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.888,
  "latency_p95_ms": 3.584,
...
```json
{
  ...
  "latency_p50_ms": 8.037,
  "latency_p95_ms": 8.966,
  "latency_p99_ms": 9.672,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-10T14:32:00.131217+00:00",
  "window_start_utc": "2026-03-10T14:31:00.129320+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.207,
  "latency_p95_ms": 8.165,
  "latency_p99_ms": 8.876,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-10T14:33:00.201439+00:00",
  "window_start_utc": "2026-03-10T14:32:00.175341+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 8.812,
  "latency_p50_ms": 8.247,
  "latency_p95_ms": 8.891,
  "latency_p99_ms": 9.595,
  "latency_second_half_p95_ms": 8.931,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-10T14:38:00.088880+00:00",
  "window_start_utc": "2026-03-10T14:33:00.257931+00:00"
}
```
