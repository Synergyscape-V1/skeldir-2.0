...
- **Candidate SHA:** `8d6737efc6cdee6cba413c2884719019a4e9352e`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23366498398
- **Generated at:** `2026-03-20T23:31:26.540126+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-20T23:22:44.208296+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.936,
  "latency_p95_ms": 2.464,
...
```json
{
  ...
  "latency_p50_ms": 8.985,
  "latency_p95_ms": 9.747,
  "latency_p99_ms": 11.109,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-03-20T23:25:26.450630+00:00",
  "window_start_utc": "2026-03-20T23:24:26.448855+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 8.833,
  "latency_p95_ms": 9.527,
  "latency_p99_ms": 10.732,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-03-20T23:26:26.518916+00:00",
  "window_start_utc": "2026-03-20T23:25:26.488953+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.495,
  "latency_p50_ms": 9.401,
  "latency_p95_ms": 10.713,
  "latency_p99_ms": 12.006,
  "latency_second_half_p95_ms": 10.838,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-03-20T23:31:26.399578+00:00",
  "window_start_utc": "2026-03-20T23:26:26.565767+00:00"
}
```
