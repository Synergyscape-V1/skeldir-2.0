...
- **Candidate SHA:** `e5f13abaaa08b65ba2f674bf6403ca86e66c8cfe`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24563428063
- **Generated at:** `2026-04-17T11:57:06.873905+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-04-17T11:47:49.510987+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.001,
  "latency_p95_ms": 4.719,
...
```json
{
  ...
  "latency_p50_ms": 15.904,
  "latency_p95_ms": 17.548,
  "latency_p99_ms": 18.801,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-04-17T11:51:06.761214+00:00",
  "window_start_utc": "2026-04-17T11:50:06.749530+00:00"
}
```
...
```json
{
  ...
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 15.6,
  "latency_p95_ms": 17.533,
  "latency_p99_ms": 19.871,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-04-17T11:52:06.837217+00:00",
  "window_start_utc": "2026-04-17T11:51:06.798668+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 19.123,
  "latency_p50_ms": 17.562,
  "latency_p95_ms": 19.155,
  "latency_p99_ms": 20.682,
  "latency_second_half_p95_ms": 19.209,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-04-17T11:57:06.724071+00:00",
  "window_start_utc": "2026-04-17T11:52:06.882253+00:00"
}
```
