...
- **Candidate SHA:** `6a40a4f53fe729ddeb7647fae6c160652c79c1c0`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25829892833
- **Generated at:** `2026-05-13T22:34:13.161166+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-13T22:24:58.022246+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.634,
  "latency_p95_ms": 4.268,
...
```json
{
  ...
  "latency_p50_ms": 29.859,
  "latency_p95_ms": 36.95,
  "latency_p99_ms": 41.719,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-13T22:28:12.930646+00:00",
  "window_start_utc": "2026-05-13T22:27:12.901843+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 32.093,
  "latency_p95_ms": 50.928,
  "latency_p99_ms": 56.356,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-13T22:29:13.054395+00:00",
  "window_start_utc": "2026-05-13T22:28:12.985387+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 36.731,
  "latency_p50_ms": 26.822,
  "latency_p95_ms": 34.89,
  "latency_p99_ms": 39.962,
  "latency_second_half_p95_ms": 30.943,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-13T22:34:12.957896+00:00",
  "window_start_utc": "2026-05-13T22:29:13.106868+00:00"
}
```
