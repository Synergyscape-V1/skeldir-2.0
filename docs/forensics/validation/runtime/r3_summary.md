...
- **Candidate SHA:** `216d05706cc44c118bebd136acefb4d736b968cc`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/26182279591
- **Generated at:** `2026-05-20T18:44:32.514528+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-20T18:35:06.370258+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.319,
  "latency_p95_ms": 3.115,
...
```json
{
  ...
  "latency_p50_ms": 21.46,
  "latency_p95_ms": 24.087,
  "latency_p99_ms": 26.732,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-20T18:38:32.377744+00:00",
  "window_start_utc": "2026-05-20T18:37:32.358640+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.936,
  "latency_p95_ms": 24.804,
  "latency_p99_ms": 28.355,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-20T18:39:32.460674+00:00",
  "window_start_utc": "2026-05-20T18:38:32.417605+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 24.929,
  "latency_p50_ms": 22.401,
  "latency_p95_ms": 24.817,
  "latency_p99_ms": 28.463,
  "latency_second_half_p95_ms": 24.714,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-20T18:44:32.355323+00:00",
  "window_start_utc": "2026-05-20T18:39:32.507213+00:00"
}
```
