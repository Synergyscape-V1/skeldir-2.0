...
- **Candidate SHA:** `4f765d4ddbc4d7fb26ba4aa49c46b35d904597c8`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/27102729666
- **Generated at:** `2026-06-07T19:49:13.329524+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-06-07T19:39:46.808495+00:00`
...
```json
{
  ...
  "latency_p50_ms": 1.976,
  "latency_p95_ms": 16.005,
...
```json
{
  ...
  "latency_p50_ms": 20.097,
  "latency_p95_ms": 22.037,
  "latency_p99_ms": 24.346,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-06-07T19:43:13.227755+00:00",
  "window_start_utc": "2026-06-07T19:42:13.213220+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.134,
  "latency_p95_ms": 21.483,
  "latency_p99_ms": 25.135,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-06-07T19:44:13.293310+00:00",
  "window_start_utc": "2026-06-07T19:43:13.263868+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 22.335,
  "latency_p50_ms": 20.743,
  "latency_p95_ms": 22.437,
  "latency_p99_ms": 24.349,
  "latency_second_half_p95_ms": 22.515,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-06-07T19:49:13.181095+00:00",
  "window_start_utc": "2026-06-07T19:44:13.334736+00:00"
}
```
