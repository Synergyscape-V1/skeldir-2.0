...
- **Candidate SHA:** `ed89e3d6d617f1a5d918881f5f01a3bdb9f0b771`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/36264301390
- **Generated at:** `2026-09-26T19:07:19.047821+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-09-26T18:57:22.914134+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.612,
  "latency_p95_ms": 3.051,
...
```json
{
  ...
  "latency_p50_ms": 49.772,
  "latency_p95_ms": 57.417,
  "latency_p99_ms": 72.699,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-09-26T19:01:18.848269+00:00",
  "window_start_utc": "2026-09-26T19:00:18.801280+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 67.052,
  "latency_p95_ms": 129.377,
  "latency_p99_ms": 189.86,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-09-26T19:02:18.967019+00:00",
  "window_start_utc": "2026-09-26T19:01:18.890296+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 48.459,
  "latency_p50_ms": 43.769,
  "latency_p95_ms": 48.459,
  "latency_p99_ms": 56.388,
  "latency_second_half_p95_ms": 48.544,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-09-26T19:07:18.880013+00:00",
  "window_start_utc": "2026-09-26T19:02:19.013388+00:00"
}
```
