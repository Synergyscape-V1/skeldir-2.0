...
- **Candidate SHA:** `3b439590ffca29f561f36ec40f4f32b28eeac839`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23021682653
- **Generated at:** `2026-03-12T20:20:30.542079+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-12T20:11:46.557055+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.038,
  "latency_p95_ms": 2.553,
...
```json
{
  ...
  "latency_p50_ms": 7.66,
  "latency_p95_ms": 8.949,
  "latency_p99_ms": 10.95,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-12T20:14:30.417177+00:00",
  "window_start_utc": "2026-03-12T20:13:30.414237+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 7.387,
  "latency_p95_ms": 9.107,
  "latency_p99_ms": 10.529,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-12T20:15:30.496345+00:00",
  "window_start_utc": "2026-03-12T20:14:30.465029+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 9.842,
  "latency_p50_ms": 8.405,
  "latency_p95_ms": 9.59,
  "latency_p99_ms": 11.576,
  "latency_second_half_p95_ms": 9.462,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-12T20:20:30.392114+00:00",
  "window_start_utc": "2026-03-12T20:15:30.558593+00:00"
}
```
