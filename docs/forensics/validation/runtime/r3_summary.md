...
- **Candidate SHA:** `4bde84b76123afb77f87474cbc79ee0515e95162`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/25517306407
- **Generated at:** `2026-05-07T19:37:16.501967+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-05-07T19:27:50.917315+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.207,
  "latency_p95_ms": 3.164,
...
```json
{
  ...
  "latency_p50_ms": 20.259,
  "latency_p95_ms": 22.912,
  "latency_p99_ms": 27.071,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-05-07T19:31:16.359629+00:00",
  "window_start_utc": "2026-05-07T19:30:16.342607+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.513,
  "latency_p95_ms": 23.361,
  "latency_p99_ms": 26.17,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-05-07T19:32:16.443610+00:00",
  "window_start_utc": "2026-05-07T19:31:16.398818+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 22.727,
  "latency_p50_ms": 20.933,
  "latency_p95_ms": 22.727,
  "latency_p99_ms": 25.433,
  "latency_second_half_p95_ms": 22.756,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-05-07T19:37:16.335935+00:00",
  "window_start_utc": "2026-05-07T19:32:16.489680+00:00"
}
```
