...
- **Candidate SHA:** `059f8a539da5287c4d3a0c5e0d9629602dcd8e81`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/22809669612
- **Generated at:** `2026-03-07T23:48:12.452406+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-03-07T23:39:26.390190+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.272,
  "latency_p95_ms": 2.835,
...
```json
{
  ...
  "latency_p50_ms": 9.158,
  "latency_p95_ms": 10.446,
  "latency_p99_ms": 11.388,
  ...
  "window_dlq_rows": 348,
  "window_end_utc": "2026-03-07T23:42:12.294789+00:00",
  "window_start_utc": "2026-03-07T23:41:12.283915+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 9.214,
  "latency_p95_ms": 10.495,
  "latency_p99_ms": 11.65,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 552,
  "window_end_utc": "2026-03-07T23:43:12.378444+00:00",
  "window_start_utc": "2026-03-07T23:42:12.344310+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 10.319,
  "latency_p50_ms": 9.299,
  "latency_p95_ms": 10.165,
  "latency_p99_ms": 11.664,
  "latency_second_half_p95_ms": 9.836,
  ...
  "window_dlq_rows": 300,
  "window_end_utc": "2026-03-07T23:48:12.277971+00:00",
  "window_start_utc": "2026-03-07T23:43:12.441036+00:00"
}
```
