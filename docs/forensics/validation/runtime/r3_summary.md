...
- **Candidate SHA:** `c58d7ded044453a8a87aa6a72998bf1ea7584313`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/33334034016
- **Generated at:** `2026-08-30T20:44:58.283938+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-30T20:35:34.497845+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.129,
  "latency_p95_ms": 11.393,
...
```json
{
  ...
  "latency_p50_ms": 20.856,
  "latency_p95_ms": 23.437,
  "latency_p99_ms": 26.86,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-30T20:38:58.131149+00:00",
  "window_start_utc": "2026-08-30T20:37:58.113831+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 20.567,
  "latency_p95_ms": 24.605,
  "latency_p99_ms": 31.31,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-30T20:39:58.216941+00:00",
  "window_start_utc": "2026-08-30T20:38:58.171750+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.921,
  "latency_p50_ms": 22.527,
  "latency_p95_ms": 24.233,
  "latency_p99_ms": 26.674,
  "latency_second_half_p95_ms": 24.506,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-30T20:44:58.112592+00:00",
  "window_start_utc": "2026-08-30T20:39:58.262981+00:00"
}
```
