...
- **Candidate SHA:** `ec0e27d8d179d381da94b7aab92961f0d6c3e22c`
- **CI run:** https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/30826681827
- **Generated at:** `2026-08-03T15:27:05.583485+00:00`
...
- `R3_CONCURRENCY` = `200`
- `R3_TIMEOUT_S` = `10.0`
- `RUN_START_UTC` = `2026-08-03T15:17:45.839832+00:00`
...
```json
{
  ...
  "latency_p50_ms": 2.026,
  "latency_p95_ms": 11.363,
...
```json
{
  ...
  "latency_p50_ms": 20.575,
  "latency_p95_ms": 23.699,
  "latency_p99_ms": 29.549,
  ...
  "window_dlq_rows": 174,
  "window_end_utc": "2026-08-03T15:21:05.445740+00:00",
  "window_start_utc": "2026-08-03T15:20:05.432083+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": null,
  "latency_p50_ms": 19.757,
  "latency_p95_ms": 23.692,
  "latency_p99_ms": 29.212,
  "latency_second_half_p95_ms": null,
  ...
  "window_dlq_rows": 276,
  "window_end_utc": "2026-08-03T15:22:05.523129+00:00",
  "window_start_utc": "2026-08-03T15:21:05.483791+00:00"
}
```
...
```json
{
  ...
  "http_timeout_count": 0,
  "latency_first_half_p95_ms": 23.267,
  "latency_p50_ms": 22.35,
  "latency_p95_ms": 23.811,
  "latency_p99_ms": 25.421,
  "latency_second_half_p95_ms": 24.265,
  ...
  "window_dlq_rows": 150,
  "window_end_utc": "2026-08-03T15:27:05.415566+00:00",
  "window_start_utc": "2026-08-03T15:22:05.568983+00:00"
}
```
