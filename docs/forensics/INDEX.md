...
| B1.1 P1 remediation findings | docs/forensics/evidence/b11_p1/B11_P1_FINDINGS_AND_REMEDIATIONS.md | B1.1-P1 SSOT contract, namespacing boundary, IaC control-plane, and CI adjudication findings/remediation record. | PR #101 / 0b47d379d | pending (main adjudication required) |
| B1.1 P1 proof index | docs/forensics/evidence/b11_p1/PROOF_INDEX.md | Gate-to-artifact proof map for B1.1-P1 (SSOT, namespace deny, IaC state, audit evidence, CI links). | PR #101 / 0b47d379d | pending (main adjudication required) |
