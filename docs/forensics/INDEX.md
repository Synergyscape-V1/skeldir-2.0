...
| B2.2-P2 remediation evidence pack | docs/forensics/Phase B2.2-P2 Remediation Evidence Pack .md | Post-auth privacy boundary closure evidence for verification-substrate integrity, zero disallowed durable ingress identifiers on webhook-path surfaces, duplicate side-effect suppression, and merge-blocking CI enforcement. | PR #357 / pending | pending |
