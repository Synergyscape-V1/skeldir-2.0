...
| B1.6-P4 remediation evidence pack | docs/forensics/B1.6-P4 Remediation Evidence Pack .md | Request-local correction-informed regeneration, single attempt-budget cap, sink isolation, fail-closed API fallback hardening, and adjudicative CI gate wiring for B1.6-P4. | PR #pending / pending | pending |
