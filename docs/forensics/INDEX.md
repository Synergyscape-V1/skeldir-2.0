...
| B2.2-P3 remediation evidence pack | docs/forensics/B2.2-P3 Remediation Evidence Pack .md | Canonical provider-preserving ingress identity envelope + explicit verified-commerce ingress state + canonical monetary substrate remediation evidence with merge-blocking CI adjudication for B2.2-P3. | PR #361 / 473cf535b7e017bdd53fcf6154dc4e1d27d5e796 | https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/24683594496 |
