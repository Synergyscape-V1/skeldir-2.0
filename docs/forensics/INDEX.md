...
| B1.4-P0 remediation evidence pack | docs/forensics/B1.4-P0 Remediation Evidence Pack.md | Corrective closeout ledger for 24-hour session authority reconciliation, deletion exposure adjudication, governance record integrity repair, and universal main-coherence verification. | PR #206 / pending | pending |
| B1.4-P0 privacy authority lock remediation pack | docs/forensics/B1.4-P0_Privacy_Authority_Lock_Remediation_Pack.md | Companion authority-lock closure pack mapping hypothesis adjudication, lifecycle fixes, acceptance-plane checks, and post-merge main workflow evidence for corrective closure. | PR #206 / pending | pending |
