...
| B1.6-P6 remediation evidence pack | docs/forensics/B1.6-P6 Remediation Evidence Pack .md | Mounted runtime adjudication evidence proving investigation/budget hallucination blocking before persistence and user-visible response, cache replay rejection without provider reentry, failure-sink insert proof, and merge-blocking CI gate wiring for B1.6-P6. | PR #282 / 567104607cc0df120b4be82ce4ced4838e418612 | pending |
