...
| B1.5-P6 remediation evidence pack | docs/forensics/B1.5-P6 Remediation Evidence Pack .md | Anti-cyborg governance lock evidence covering realtime exception registry, TypeScript AST/graph import fencing, machine-readable prohibited-signature matrix, deny-by-default escalation overrides, and non-vacuous negative controls. | PR #pending / pending | pending |
