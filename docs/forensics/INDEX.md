...
| B1.5-P5 remediation evidence pack | docs/forensics/B1.5-P5 Remediation Evidence Pack .md | Frontend control-grammar wiring evidence covering generated-client status polling discipline, contract-driven review-rail activation, idempotent mutation wiring, strict deterministic-vs-synthesis rendering, bounded B1.5 scope controls, and non-vacuous frontend enforcement proofs. | PR #251 / b3362d23a589444e84493564c5693aec77f7ae6c | pending |
