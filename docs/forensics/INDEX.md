...
| B1.2-P2 corrective baseline proof | docs/forensics/B1.2-P2_CORRECTIVE_PROOF_BASELINE.md | Pre-remediation SQL baseline for users registry least-privilege corrective gap (roles, grants, users RLS, lookup boundary, users schema invariant). | PR pending | pending |
| B1.2-P2 corrective evidence | docs/forensics/B1.2-P2_CORRECTIVE_EVIDENCE.md | Exit-gate mapped corrective evidence for users registry least-privilege lock (self-only users RLS, non-enumerability, tenantless lookup boundary, CI negative controls). | PR pending | pending |
