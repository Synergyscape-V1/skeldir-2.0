...
| B1.3-P4 remediation evidence pack | docs/forensics/B1.3-P4_Remediation_Evidence_Pack.md | Secret-path exclusivity, least-privilege mutation RBAC, structural non-leak boundary hardening, and P4 CI adjudication proof. | PR #189 / pending | pending |
