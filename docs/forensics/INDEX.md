...
| B1.5-P7 remediation evidence pack | docs/forensics/B1.5-P7 Remediation Evidence Pack .md | CI-adjudicated closure proof bundle for canonical launch->poll->review->terminalization, controlled-time poll cadence validation, failure-state recovery visibility, request-layer idempotency replay proof, static+runtime anti-theater gating, and honest mental-model study handling. | pending | pending |
| B1.5-P7 mental-model study README | docs/forensics/evidence/b15_p7/mental_model_study/README.md | Study package index for human-executed async-review mental-model validation protocol and evidence handling rules. | PR #263 / pending | pending |
| B1.5-P7 mental-model study protocol | docs/forensics/evidence/b15_p7/mental_model_study/protocol.md | Human-executable participant protocol for validating recommendation-review mental model comprehension. | PR #263 / pending | pending |
| B1.5-P7 mental-model facilitator script | docs/forensics/evidence/b15_p7/mental_model_study/facilitator_script.md | Standardized facilitator script to avoid introducing synchronous-chat framing bias during sessions. | PR #263 / pending | pending |
| B1.5-P7 mental-model scoring rubric | docs/forensics/evidence/b15_p7/mental_model_study/scoring_rubric.md | Scoring rubric defining pass/fail interpretation for async review-model understanding. | PR #263 / pending | pending |
| B1.5-P7 mental-model execution checklist | docs/forensics/evidence/b15_p7/mental_model_study/execution_checklist.md | Session-by-session execution checklist to preserve protocol integrity and evidentiary traceability. | PR #263 / pending | pending |
