...
| B1.6-P3 remediation evidence pack | docs/forensics/B1.6-P3 Remediation Evidence Pack .md | Corrective-action numeric authority evidence covering fail-closed binding adjudication, binding-driven tolerance enforcement, cache anti-runaway suppression, deterministic-supremacy preservation, and CI-adjudicated negative controls. | PR #275 / pending | pending |
