...
| B1.2-P2 remediation evidence | docs/forensics/B1.2-P2_REMEDIATION_EVIDENCE.md | Initial findings + remediations for privacy-safe auth substrate, RLS isolation, migration reversibility, and 0-PII CI audits. | PR #139 / pending | pending |
