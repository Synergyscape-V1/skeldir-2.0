...
| B1.2-P9 baseline | docs/forensics/evidence/b12_p9/P9_baseline.md | Forensic baseline for final IC2-style composed E2E gate readiness, blocker hypotheses, and live branch-protection state capture. | PR #180 / cbfc1a8ea | pending |
| B1.2-P9 evidence pack | docs/forensics/B1.2-P9_EVIDENCE.md | Exit-gate mapped evidence for EG9.1-EG9.5 and EG9.CI across composed API/DB/worker/webhook runtime with CI enforcement-plane linkage. | PR #180 / cbfc1a8ea | pending |
