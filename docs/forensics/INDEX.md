...
| B1.4-P2 remediation evidence pack | docs/forensics/B1.4-P2 Remediation Evidence Pack .md | Event substrate rewrite + session authority introduction evidence pack with schema/runtime/CI proof-lane adjudication. | PR #215 / pending | pending |
