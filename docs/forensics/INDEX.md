...
| B1.4-P4 remediation evidence pack | docs/forensics/B1.4-P4 Remediation Evidence Pack .md | Split-substrate remediation evidence for retention + deterministic deletion semantics, including raw payload offloading, 90-day GC, GDPR/CCPA erasure tombstones, and P2/P3 preservation proofs. | PR #pending / pending | pending |
