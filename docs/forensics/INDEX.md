...
| B1.6-P6 remediation evidence pack | docs/forensics/B1.6-P6 Remediation Evidence Pack .md | Mounted runtime adjudication evidence proving investigation/budget hallucination blocking before persistence and user-visible response, cache replay rejection without provider reentry, failure-sink insert proof, and merge-blocking CI gate wiring for B1.6-P6. | PR #282 / 928d658ad75b5f1d238e8dfb768697f673a43c14 | https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23909949699 |
