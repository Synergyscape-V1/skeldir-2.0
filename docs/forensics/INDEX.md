...
| B1.2-P3 v4 baseline | docs/forensics/B1.2-P3_V4_BASELINE.md | Baseline findings for lock semantics, lock-miss behavior, steady-state DB access, and required-check enrollment before v4 corrective patch. | PR pending / pending | pending |
| B1.2-P3 v4 corrective evidence | docs/forensics/B1.2-P3_V4_CORRECTIVE_EVIDENCE.md | Exit-gate mapped evidence for transaction-scoped xact lock, bounded lock-miss polling, hot-path 0-DB proof, and enforcement-plane required-check wiring. | PR pending / pending | pending |
