...
| B1.7-P3 remediation evidence pack | docs/forensics/B1.7-P3 Remediation Evidence Pack .md | Deterministic watermark-first cache replay identity, stale replay rejection without provider reentry, and structured truth-snapshot coherence proof closure for B1.7-P3. | PR #293 / e0bac5cb8f8cbaa96abaccedf223be8c9c2c5f04 | pending |
