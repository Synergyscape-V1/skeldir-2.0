...
| B1.1 P6 closure pack | docs/forensics/evidence/b11_p6/README.md | End-to-end B1.1 closure pack index for integrated gates, immutable proof mapping, and CI adjudication artifacts. | PR #128 / pending | pending |
