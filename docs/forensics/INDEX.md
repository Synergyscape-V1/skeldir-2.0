...
| B1.4-P3 remediation evidence pack | docs/forensics/B1.4-P3 Remediation Evidence Pack .md | Attribution locality rebinding evidence for session-bounded worker/read surfaces, bounded telemetry inventory, conversion-path adjudication, and merge-blocking P3 proof-lane wiring. | PR #pending / pending | pending |
