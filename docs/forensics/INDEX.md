...
| B2.1-P1 remediation evidence pack | docs/forensics/B2.1-P1 Remediation Evidence Pack .md | Canonical input semantics + replay identity lock evidence for B2.1-P1 covering taxonomy authority, immutable deterministic input/output contracts, wall-clock replay-pollution removal, explicit 30-day lookback runtime lock, and non-vacuous CI/runtime adjudication surfaces. | PR #pending / pending | pending |
