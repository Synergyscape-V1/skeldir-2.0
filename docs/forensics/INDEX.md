...
| B1.7-P6 remediation evidence pack | docs/forensics/B1.7-P6 Remediation Evidence Pack .md | Final end-to-end validation remediation evidence covering composed mounted correctness, benchmark gate adjudication topology, benchmark validity hardening, and protected-branch PR/main closure semantics for B1.7-P6. | PR #315 / pending | CI in-progress on PR #315; benchmark efficacy remains red under restored semantics |
