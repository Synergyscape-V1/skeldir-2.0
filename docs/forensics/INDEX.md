...
| B2.2-P0 remediation evidence pack | docs/forensics/Phase B2.2-P0 Remediation Evidence Pack .md | Runtime/contract authority convergence and declared webhook surface lock evidence with merge-blocking CI enforcement. | PR #347 / pending | pending |
