...
| B2.2-P0 remediation evidence pack | docs/forensics/Phase B2.2-P0 Remediation Evidence Pack .md | Follow-up corrective evidence for architecturally correct public webhook topology lock (4-platform public surface + runtime-only Stripe alias), authority-chain convergence, and merge-blocking CI enforcement. | PR #350 / pending | pending |
| B2.2-P0 remediation evidence pack alias | docs/forensics/B2.2-P0 Remediation Evidence Pack .md | Directive-alias pointer to the canonical Phase B2.2-P0 remediation evidence document. | PR #350 / pending | pending |
