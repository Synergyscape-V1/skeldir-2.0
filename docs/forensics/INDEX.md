...
| B0.7 Phase 5 compute safety | docs/forensics/b07_phase5_compute_safety_proof_index.md | Compute safety proof index for EG5.1-EG5.9 (LLM/Bayesian bounded-compute gates). | PR #82 / pending | pending |
