...
| B1.2-P4 corrective baseline | docs/forensics/B1.2-P4_CORRECTIVE_BASELINE.md | Corrective-action baseline mapping for H01-H04 (family-revoke on reuse, tenant determinism, secret-only hashing, attacker-first proof gap). | PR #155 / pending | pending |
| B1.2-P4 corrective evidence | docs/forensics/B1.2-P4_CORRECTIVE_EVIDENCE.md | Corrective exit-gate evidence for tenant-required issuance, secret-only hashing, family revocation on reuse, and non-vacuous negative controls. | PR #155 / pending | pending |
