...
| B1.4-P4 remediation evidence pack | docs/forensics/B1.4-P4 Remediation Evidence Pack .md | Split-substrate remediation evidence for retention + deterministic deletion semantics, including raw payload offloading, 90-day GC, GDPR/CCPA erasure tombstones, and P2/P3 preservation proofs. | PR #225 / ff52bdc5b7ec1fd330d4f5af5228048fb202da9c | https://github.com/Synergyscape-V1/skeldir-2.0/actions/runs/23389046209 |
