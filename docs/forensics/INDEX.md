...
| B2.1-P0 remediation evidence pack | docs/forensics/B2.1-P0 Remediation Evidence Pack .md | Runtime/contract/generated-artifact/CI authority convergence evidence for B2.1-P0 including substrate lineage proof, channels-surface truth alignment, canonical attribution root lock, and broker bootstrap defect repair. | PR #317 / c74afc940 | pending |
