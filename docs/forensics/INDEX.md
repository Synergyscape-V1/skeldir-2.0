...
| B2.1-P4 remediation evidence pack | docs/forensics/B2.1-P4 Remediation Evidence Pack.md | Queue isolation + performance semantics lock closure evidence for deterministic-vs-Bayesian worker separation, real enqueue-to-commit benchmark adjudication, co-routed contention negative control, mounted read-path recompute-free proof, and non-vacuous CI governance hardening. | pending | pending |
