...
| B1.4-P3 remediation evidence pack | docs/forensics/B1.4-P3 Remediation Evidence Pack .md | Attribution locality rebinding follow-up corrective evidence for reporting-surface partition truth, Stripe v2 recompute coverage, bounded continuity/session-hint adjudication, telemetry sufficiency proofs, and merge-blocking P3 proof-lane hardening. | PR #221 / a0c909f7f | pending |
