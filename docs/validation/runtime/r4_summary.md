...
- **Candidate SHA:** `4ecf6b976ccdcc09587abd41168f8b6d359ed1c9`
- **CI run:** https://github.com/Muk223/skeldir-2.0/actions/runs/20601936906
- **Generated at:** `2025-12-30T17:17:34.725281+00:00`
...
- `tenant_a` = `70fb07b3-7c27-5365-979b-c82ed71a1293`
- `tenant_b` = `efd04f39-c85e-5e22-85c2-d25c34e3a8af`
...
{
  "N": 10,
  "candidate_sha": "4ecf6b976ccdcc09587abd41168f8b6d359ed1c9",
  "db_truth": {
    "attempts": {
  ...
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20601936906",
...
```json
{
  ...
  "worker_observed": {
    ...
    "kombu_payload_debug": {
      "found": true,
      "headers_id": "1e937a4b-54e2-534c-92dc-f1daae4a874a",
    ...
    "worker_pid_after": 3090,
    "worker_pid_before": 2675,
    "worker_pid_restarts": [
      2720,
      2761,
      2805,
...
```json
{
  ...
  "candidate_sha": "4ecf6b976ccdcc09587abd41168f8b6d359ed1c9",
  "db_truth": {
    "target_row_id": "ebfea242-f326-4881-874f-fec871b44663"
  },
  "passed": true,
  "run_url": "https://github.com/Muk223/skeldir-2.0/actions/runs/20601936906",
