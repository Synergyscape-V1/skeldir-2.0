...
**Branch tip:** `7a41a3a2` (includes forensics doc follow-ups)  
...
- **Push:** `origin/feat/discoverability-remediation` at `7a41a3a2` (D3 feature `a410242a` plus forensics doc commits).
