...
import { BusinessEmailInput } from '../signup/BusinessEmailInput';
import { GoogleOAuthButton } from '../signup/GoogleOAuthButton';
import { MicrosoftOAuthButton } from '../signup/MicrosoftOAuthButton';
    ...
    return (
        <div className="w-full max-w-md space-y-8">
            <div className="space-y-2 auth-form-header" style={{ textAlign: 'left' }}>
                <h1 className="tracking-tight auth-form-title" style={{ color: 'var(--color-black, #000000)', fontWeight: 600, whiteSpace: 'nowrap', fontSize: '2.25rem', lineHeight: 1.2, margin: 0, padding: 0 }}>
                    Login to get started with Skeldir
                </h1>
