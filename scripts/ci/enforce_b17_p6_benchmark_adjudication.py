    ...
    *,
    ...
    if baseline_overall_p95 is not None and prewarm_overall_p95 is not None:
        _require(
            ...
            failures,
            "prewarm_efficacy_no_overall_p95_improvement",
        )
    if baseline_hit_ratio is not None and prewarm_hit_ratio is not None:
        _require(
            prewarm_hit_ratio >= baseline_hit_ratio,
            failures,
            "prewarm_efficacy_no_cache_hit_ratio_improvement",
        )
