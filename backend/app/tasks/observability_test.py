...
from app.tasks.context import assert_worker_auth_envelope_active, run_in_worker_loop, tenant_task
...
@celery_app.task(bind=True, name="app.tasks.observability_test.auth_envelope_probe", routing_key="housekeeping.task")
@tenant_task
