            ...
            await conn.execute(
                text("""
                    INSERT INTO attribution_events (
                        ...
                        (:id1, :tenant_id, '2025-05-01T10:00:00Z'::timestamptz, :session_id_1, :idempotency_key_1, 'purchase', 'direct', 10000, '{}'::jsonb),
                        (:id2, :tenant_id, '2025-05-01T15:00:00Z'::timestamptz, :session_id_2, :idempotency_key_2, 'purchase', 'direct', 20000, '{}'::jsonb)
            ...
            await conn.execute(
                text("""
                    INSERT INTO attribution_events (
                        ...
                        (:id1, :tenant_id, '2025-06-01T10:00:00Z'::timestamptz, :session_id_1, :idempotency_key_1, 'purchase', 'direct', 10000, '{}'::jsonb),
                        (:id2, :tenant_id, '2025-06-01T15:00:00Z'::timestamptz, :session_id_2, :idempotency_key_2, 'purchase', 'direct', 20000, '{}'::jsonb)
                    ON CONFLICT DO NOTHING
                """),
                {
                    "id1": event_id_1,
