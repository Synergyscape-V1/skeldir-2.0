...
const theme = AGENTS.find((candidate) => candidate.id === "B");
if (!theme) {
  throw new Error("Missing theme for agent B");
}

const meta: Meta<PlatformIntegrationsStoryArgs> = {
  title: "Platform Integrations/Agent B - Status-First Visual Hierarchy",
