...
import { HorizontalNavShell } from '../../explorations/channel-detail/da-3/HorizontalNavShell';
import { ChannelDetailPage } from '../../explorations/channel-detail/da-3/ChannelDetailPage';
...
const meta: Meta<typeof FullPage> = {
  title: 'Channel Detail Explorations/DA3 Timeline',
  component: FullPage,
  decorators: [
    (Story) => (
