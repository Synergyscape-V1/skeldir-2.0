...
import { HorizontalNavShell } from '../../explorations/channel-detail/da-5/HorizontalNavShell';
import { ChannelDetailPage } from '../../explorations/channel-detail/da-5/ChannelDetailPage';
...
const meta: Meta<typeof FullPage> = {
  title: 'Channel Detail Explorations/DA5 Compact',
  component: FullPage,
  decorators: [
    (Story) => (
