    ...
    >
      ...
      <div className="nav-items-wrap">
        <nav className="nav-items" aria-label="Primary">
          <ShellNavItems activeRoute="Command Center" textColor={theme.text} />
        </nav>
      </div>
...
export function AgentShellCommandCenter({
  theme,
  scenario,
  dataset = "mixed",
  density = 100,
  onChannelActivate,
  getChannelDetailHref,
}: {
  theme: AgentTheme;
  ...
  getChannelDetailHref?: (channelId: string) => string | null;
}) {
  return (
    <div
    ...
    >
      ...
      <main
        ...
        style={{
          overflow: "auto",
          minHeight: "auto",
          // Command Center header strip should start at the top edge.
          margin: 0,
          padding: 0,
          paddingBottom: 0,
        }}
