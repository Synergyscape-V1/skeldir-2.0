...
import { BudgetOptimizer } from "../budget/components/BudgetOptimizer";
...
export function AgentShellBudgetOptimizer({
  theme,
  density = 100,
}: {
  theme: AgentTheme;
      ...
      >
        ...
        <div className="nav-items-wrap">
          <nav className="nav-items" aria-label="Primary">
            <ShellNavItems activeRoute="Budget" activeChild="budget-optimizer" textColor={theme.text} />
          </nav>
        </div>
      </header>
      <main
