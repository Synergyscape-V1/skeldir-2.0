...
function SidebarProvider({
  ...
  // Initialize from localStorage if available, fallback to defaultOpen
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This sets localStorage and cookie to keep the sidebar state.
      if (typeof window !== "undefined") {
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 pt-2 pr-2 pb-2 overflow-visible", className)}
      {...props}
    />
  )
}
